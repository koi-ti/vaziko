...
use App\Models\Accounting\Asiento, App\Models\Accounting\Asiento2, App\Models\Accounting\PlanCuenta, App\Models\Accounting\SaldoContable, App\Models\Accounting\SaldoTercero, App\Models\Base\Tercero;
use DB;
...
class SaldosContables extends Command
{
    ...
    public function handle()
    {
        ...
        //
        // $asientos = Asiento::where('asiento1_ano', $currentyear)->where('asiento1_mes', $currentmonth)->get();
        ...
        //         // dd($currentyear, $currentmonth, $prevyear, $prevmonth);
        //         //
        ...
        //             }
        //
        //             $tercero = Tercero::find($asiento->asiento2_beneficiario);
        //             if(!$tercero instanceof Tercero){
        //                 DB::rollback();
        //                 return $this->error('No es posible recuperar el tercero.');
        //             }
        //
        //
        //
