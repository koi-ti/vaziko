...
$query->select('koi_asientomovimiento.*', 
    'producto_codigo', 'producto_nombre', 
    'koi_producto.id as producto_id',
    'koi_factura1.*',
    'sucursal_nombre',
    'opN.orden_referencia as orden_referenciaN',
    'opE.orden_referencia as orden_referenciaE',
    'pvN.puntoventa_nombre as puntoventa_nombreN',
    'pvN.puntoventa_prefijo as puntoventa_prefijoN',
    'pvE.puntoventa_nombre as puntoventa_nombreE',
    'pvE.puntoventa_prefijo as puntoventa_prefijoE',
    'factura4_cuota',
    'factura4_factura1',
    DB::raw("CONCAT(opN.orden_numero,'-',SUBSTRING(opN.orden_ano, -2)) as factura_ordenpN"),
    DB::raw("CONCAT(opE.orden_numero,'-',SUBSTRING(opE.orden_ano, -2)) as factura_ordenpE"),
    DB::raw("
        CASE
