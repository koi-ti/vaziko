...
use App\Models\Base\Tercero, App\Models\Production\Materialp, App\Models\Production\Ordenp2, App\Models\Production\Ordenp4, App\Models\Production\Ordenp6, App\Models\Inventory\Producto;
use DB, Log;
        ...
        if ($request->ajax()) {
            ...
            if ( $orden4->isValid($data) ) {
                try {
                    ...
                    $proveedor = Tercero::where('tercero_nit', $request->orden4_proveedor)->first();
                    ...
                    // Commit Transaction
                    return response()->json(['success' => true, 'id' => uniqid(), 'materialp_nombre' => $materialp->materialp_nombre, 'proveedor_nombre' => $request->orden4_proveedor_nombre, 'proveedor_nit' => $proveedor->tercero_nit, 'producto_nombre' => $insumo->producto_nombre]);
                }catch(\Exception $e){
