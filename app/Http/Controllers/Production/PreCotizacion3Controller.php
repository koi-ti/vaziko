...
use App\Models\Production\Materialp, App\Models\Production\PreCotizacion3;
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            if ($request->has('insumo')) {
                $data = PreCotizacion3::select('koi_precotizacion3.id', 'precotizacion3_valor_unitario as valor')->where('precotizacion3_producto', $request->insumo)->orderBy('id', 'desc')->first();
            }
