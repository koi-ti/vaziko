...
class Asiento extends Model
{
    ...
    {
        $query = Asiento::query();
        $query->select('koi_asiento1.*', 'folder_nombre', 'documento_nombre', 'tercero_nit', DB::raw("(CASE WHEN tercero_persona = 'N' THEN CONCAT(tercero_nombre1,' ',tercero_nombre2,' ',tercero_apellido1,' ',tercero_apellido2) ELSE tercero_razonsocial END) as tercero_nombre"));
