...
class Ordenp4 extends Model
{
    ...
    public static function getOrdenesp4($productop = null, $ordenp2 = null)
    {
        ...
        $query->select('koi_materialp.id as id', 'materialp_nombre', ($ordenp2 != null ? DB::raw("CASE WHEN koi_ordenproduccion4.id IS NOT NULL THEN true ELSE false END as activo") : DB::raw('false AS activo')) );
