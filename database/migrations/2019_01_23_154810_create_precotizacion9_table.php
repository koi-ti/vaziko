     ...
     */
     public function up()
     {
         Schema::create('koi_precotizacion9', function (Blueprint $table) {
             ...
             $table->integer('precotizacion9_materialp')->unsigned();
             $table->integer('precotizacion9_producto')->unsigned()->nullable();
             ...
             $table->foreign('precotizacion9_materialp')->references('id')->on('koi_materialp')->onDelete('restrict');
