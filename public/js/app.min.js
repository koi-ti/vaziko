...
!function($, window, document, undefined) {
    ...
    app.AsientoCuentasListView = Backbone.View.extend({
        ...
        addOne: function(Asiento2Model) {
            ...
            Asiento2Model.view = view, this.$el.append(view.render().el);
        },
        addAll: function() {
    ...
    app.CreateAsientoView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.preSave = !1, this.listenTo(this.model, "change", this.render), this.listenTo(this.model, "sync", this.responseServer), 
            this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            var attributes = this.model.toJSON();
            this.$wraperForm.html(this.template(attributes)), this.$numero = this.$("#asiento1_numero"), 
            this.$form = this.$("#form-asientos"), this.referenceViews(), this.ready();
        },
        ready: function() {
            "function" == typeof window.initComponent.initToUpper && window.initComponent.initToUpper(), 
        ...
        submitPreSaveAsiento: function(e) {
            this.preSave = !0, this.$form.submit();
        },
        submitAsiento: function(e) {
            this.preSave = !1, this.$form.submit();
        },
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
                e.preventDefault();
                var data = window.Misc.formToJson(e.target);
                data.cuentas = this.asientoCuentasList.toJSON(), data.preguardado = this.preSave, 
                this.model.save(data, {
                    patch: !0,
                    silent: !0
                });
    ...
    app.ComponentSearchCuentaView = Backbone.View.extend({
        ...
        cuentaChanged: function(e) {
            ...
            this.$inputBase = this.$("#" + $(e.currentTarget).attr("data-base")), this.$inputValor = this.$("#" + $(e.currentTarget).attr("data-valor")), 
            ...
            _.isUndefined(cuenta) || _.isNull(cuenta) || "" == cuenta || $.ajax({
                ...
                _this.$inputBase.length && (_this.$inputBase.prop("readonly", !0), !_.isUndefined(resp.plancuentas_tasa) && !_.isNull(resp.plancuentas_tasa) && resp.plancuentas_tasa > 0 ? (_this.$inputBase.prop("readonly", !1), 
                _this.$inputValor.val(resp.plancuentas_tasa * _this.$inputBase.val())) : _this.$inputBase.val(0)));
            }).fail(function(jqXHR, ajaxOptions, thrownError) {
                window.Misc.removeSpinner(_this.$wraperConten), alertify.error(thrownError);
            });
        }
    ...
    app.AppRouter = new (Backbone.Router.extend({
        ...
        getAsientosEdit: function(asiento) {
            this.asientoModel = new app.AsientoModel(), this.asientoModel.set({
                ...
                silent: !0
            }), this.createAsientoView instanceof Backbone.View && (this.createAsientoView.stopListening(), 
            this.createAsientoView.undelegateEvents()), this.createAsientoView = new app.CreateAsientoView({
                model: this.asientoModel
...
!function($, window, document, undefined) {
    ...
    InitComponent.prototype = {
        initialize: function() {
            ...
            this.initToUpper(), this.initSpinner();
        },
        initApp: function() {
