/*! koi-frontend - v1.0.0 - 2017-06-13 */
...
!function($, window, document, undefined) {
    ...
    app.ProductopOrdenListView = Backbone.View.extend({
        ...
        totalize: function() {
            var data = this.collection.totalize();
            this.$unidades.length && this.$unidades.html(parseInt(data.unidades)), this.$facturado.length && this.$facturado.html(parseInt(data.facturado)), 
