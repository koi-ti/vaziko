/*! koi-frontend - v1.0.0 - 2017-08-15 */
...
!function($, window, document, undefined) {
    ...
    app.CreateOrdenpView = Backbone.View.extend({
        ...
        initialize: function() {
            this.listenTo(this.model, "change", this.render), this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            var attributes = this.model.toJSON();
    ...
    app.EditOrdenpView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !0, this.$el.html(this.template(attributes)), this.$form = this.$("#form-ordenes"), 
            this.spinner = this.$("#spinner-main"), this.referenceViews(), this.ready();
        },
        referenceViews: function() {
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner($("#spinner-main")), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                window.Misc.Redirect(window.Misc.FullUrl(Route.route("ordenes.edit", {
                    ordenes: resp.id
                }), {
                    trigger: !0
                }));
