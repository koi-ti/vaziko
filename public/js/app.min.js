    ...
    app.ComponentAddressView = Backbone.View.extend({
        ...
        listeningAddress: function(e) {
            ...
            this.addressDataNm.push(this.num)); else {
                ...
                this.addressData[this.addressData.length - 1] != $(e.target).text().trim() ? "#" == $(e.target).text().trim() || "-" == $(e.target).text().trim() ? (this.addressData.push($(e.target).text().trim()), 
        ...
        ChangeSelect: function(e) {
            var _this = this;
            if (this.$component = this.$("div#component-input").hide(), "si" == $(e.target).val()) _this.$component.show(), 
            $("input#component-input-text").change(function() {
                for (var dato = $(this).val($(this).val().toUpperCase()), permitidos = /\w/, hola = "", i = 0; i <= dato.val().length - 1; i++) dato.val().charAt(i) == permitidos && (hola += dato.val().remove(i));
                console.log(hola);
            }); else {
