/*! koi-frontend - v1.0.0 - 2017-06-27 */
!function($, window, document, undefined) {
    ...
    app.MainFacturaspView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.$searchfacturapTercero = this.$("#searchfacturap_tercero"), this.$searchfacturapTerceroNombre = this.$("#searchfacturap_tercero_nombre"), 
            this.facturaspSearchTable = this.$facturaspSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.persistent = !0, data.referencia = _this.$searchfacturapReferencia.val(), data.tercero_nit = _this.$searchfacturapTercero.val(), 
        ...
        clear: function(e) {
            e.preventDefault(), this.$searchfacturapReferencia.val(""), this.$searchfacturapTercero.val(""), 
            this.$searchfacturapTerceroNombre.val(""), this.facturaspSearchTable.ajax.reload();
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
