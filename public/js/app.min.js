/*! koi-frontend - v1.0.0 - 2017-02-20 */
...
app || (app = {}), function($, window, document, undefined) {
    ...
    app.CreateRolView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$wraperForm = this.$("#render-form-rol"), this.listenTo(this.model, "change", this.render), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.model, "request", this.loadSpinner);
        },
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
    ...
    app.RolesListView = Backbone.View.extend({
        ...
        addAll: function() {
            this.collection.forEach(this.addOne, this), console.log("addAll");
        },
        storeOne: function(data) {
            var _this = this;
            console.log("storeOne"), console.log(data), window.Misc.setSpinner(this.parameters.wrapper), 
