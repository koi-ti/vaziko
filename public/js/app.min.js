/*! koi-frontend - v1.0.0 - 2017-06-16 */
    ...
    app.FacturaDetalle2View = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.confCollection = {
                reset: !0,
                data: {}
            }, this.$facturado = this.$("#subtotal-facturado"), this.$subtotal = this.$("#subtotal-total"), 
            ...
            this.listenTo(this.collection, "sync", this.responseServer), _.isUndefined(this.parameters.dataFilter.factura2) || _.isNull(this.parameters.dataFilter.factura2) || (this.confCollection.data.factura2 = this.parameters.dataFilter.factura2, 
            this.collection.fetch(this.confCollection));
        },
        ...
        totalize: function() {
            var data = this.collection.totalize();
            this.$facturado.length && this.$facturado.html(data.facturado), this.$subtotal.length && this.$subtotal.html(window.Misc.currency(Math.round(data.subtotal)));
            var iva = .19 * data.subtotal;
            this.$iva.length && this.$iva.html(window.Misc.currency(Math.round(iva)));
            var total = data.subtotal + iva;
            this.$total.length && this.$total.html(window.Misc.currency(Math.round(total)));
        },
...
!function($, window, document, undefined) {
    ...
    app.DetalleFactura2List = Backbone.Collection.extend({
        ...
        totalize: function() {
            var facturado = this.facturado(), subtotal = this.subtotal();
