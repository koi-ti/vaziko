/*! koi-frontend - v1.0.0 - 2017-08-16 */
!function($, window, document, undefined) {
    ...
    Misc.prototype = {
        ...
        clearForm: function(form) {
            form.find(":input").each(function() {
                if (field_type = $(this), "" != field_type.attr("data-currency") && "" != field_type.attr("data-currency-negative") || field_type.val(""), 
                field_type.attr("checked") ? field_type.iCheck("check") : field_type.iCheck("uncheck"), 
                field_type.hasClass("select2-default-clear") || field_type.hasClass("select2-default")) {
                    var name = field_type.attr("id");
                    field_type.val("").trigger("change"), $("#select2-" + name + "-container").removeAttr("title");
                } else field_type.hasClass("choice-select-autocomplete") && (field_type.empty(), 
                id = field_type.attr("id"), $("#select2-" + id + "-container").removeAttr("title"));
            }), form.trigger("reset");
        },
    ...
    app.AsientoActionView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.productoSeriesINList = new app.ProductoSeriesINList(), this.detalleFactura4List = new app.DetalleFactura4List(), 
            this.listenTo(this.cuotasFPList, "reset", this.addAllCuotasFacturap), this.listenTo(this.detalleFactura4List, "reset", this.addAllFactura), 
        ...
        evaluateProductoInventario: function(e) {
            ...
            this.$wraperDetailIn.empty(), producto && sucursal && unidades && $.ajax({
                ...
                if (window.Misc.removeSpinner(_this.$wraperFormIn), resp.success) {
                    if (!parseInt(resp.producto_unidades)) return _this.$wraperErrorIn.empty().append("No es posible realizar movimientos para productos que no manejan unidades"), 
                    void _this.$wraperErrorIn.show();
                    if (parseInt(resp.producto_metrado)) if ("D" == _this.parameters.data.asiento2_naturaleza) {
                    ...
                    }); else if (parseInt(resp.producto_serie) && "D" == _this.parameters.data.asiento2_naturaleza) {
        ...
        facturaChange: function(e) {
            ...
            this.$("#wrapper-table-factura").removeAttr("hidden"), this.detalleFactura4List.reset(), 
            this.detalleFactura4List.fetch({
                reset: !0,
                data: {
        ...
        addAllFactura: function() {
            this.$wraper.find("tbody").html(""), this.detalleFactura4List.forEach(this.addOneFactura, this);
        },
        ...
        responseServer: function(model, resp, opts) {
            ...
            this.$modalFp.modal("hide"), this.$modalCt.modal("hide"), window.Misc.clearForm($("#form-item-asiento")));
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    ...
    app.ComponentSearchFacturaView = Backbone.View.extend({
        ...
        searchFactura: function(e) {
            ...
            this.$factura = this.$inputContent.attr("data-factura"), this.facturaSearchTable = this.$facturaSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.id = _this.$searchfacturaNumero.val(), data.tercero_nit = _this.$searchfacturaTercero.val();
                    }
                },
                columns: [ {
                    data: "id",
        ...
        clear: function(e) {
            e.preventDefault(), this.$searchfacturaNumero.val(""), this.$searchfacturaTercero.val(""), 
        ...
        searchOrden: function(e) {
            ...
            this.$factura = this.$inputContent.attr("data-factura"), this.ordersSearchTable = this.$ordersSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.factura = _this.$factura, data.orden_numero = _this.$searchordenpOrden.val(), 
    ...
    app.ComponentSearchOrdenP2View = Backbone.View.extend({
        ...
        searchOrden: function(e) {
            e.preventDefault();
            var _this = this;
            this.$modalComponent.find(".content-modal").html(this.template({})), this.$searchOrdenp = this.$("#search_ordenp"), 
            this.$searchOrdenpNombre = this.$("#search_ordenpnombre"), this.$ordersSearchTable = this.$modalComponent.find("#koi-search-ordenp2-component-table"), 
            this.$inputContent = this.$("#" + $(e.currentTarget).attr("data-field")), this.$inputName = this.$("#" + this.$inputContent.attr("data-name"));
            var tercero = this.$inputContent.attr("data-tercero");
            if (_.isUndefined(tercero) || _.isNull(tercero) || "" == tercero) return void alertify.error("Por favor ingrese cliente antes agregar una orden.");
            this.ordersSearchTable = this.$ordersSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.datatables = !0, data.search_ordenp = _this.$searchOrdenp.val(), data.search_ordenpnombre = _this.$searchOrdenpNombre.val();
                    }
                },
                columns: [ {
                    data: "id",
                    ...
                    data: "orden2_cantidad",
                    name: "orden2_cantidad"
                }, {
                    data: "orden2_facturado",
                    name: "orden2_facturado"
                } ],
                order: [ [ 2, "desc" ], [ 3, "desc" ] ],
                columnDefs: [ {
                    targets: 0,
        ...
        setOrden: function(e) {
            e.preventDefault();
            var data = this.ordersSearchTable.row($(e.currentTarget).parents("tr")).data();
            this.$inputContent.val(data.id), this.$inputName.val(data.productop_nombre), this.$modalComponent.modal("hide");
        },
        search: function(e) {
            e.preventDefault(), this.ordersSearchTable.ajax.reload();
        },
        clear: function(e) {
            e.preventDefault(), this.$searchOrdenp.val(""), this.$searchOrdenpNombre.val(""), 
        ...
        ordenpChanged: function(e) {
            ...
            this.$inputName.val(""), _.isUndefined(orden2_id) || _.isNull(orden2_id) || "" == orden2_id || $.ajax({
                ...
                window.Misc.removeSpinner(_this.$wraperConten), resp.success && (_.isUndefined(resp.productop_nombre) || _.isNull(resp.productop_nombre) || _this.$inputName.val(resp.productop_nombre));
            }).fail(function(jqXHR, ajaxOptions, thrownError) {
                window.Misc.removeSpinner(_this.$wraperConten), alertify.error(thrownError);
            });
        },
    ...
    app.ComponentSearchTerceroView = Backbone.View.extend({
        ...
        searchTercero: function(e) {
            ...
            this.$inputContent = this.$("#" + $(e.currentTarget).attr("data-field")), this.$inputName = this.$("#" + this.$inputContent.attr("data-name")), 
            this.$btnContact = this.$("#" + this.$inputContent.attr("data-contacto")), this.$inputOrden = this.$("#" + this.$inputContent.attr("data-orden2")), 
        ...
        setTercero: function(e) {
            ...
            this.$inputOrden.length > 0 && this.$inputOrden.attr("data-tercero", data.id), this.$btnContact.length > 0 && (this.$btnContact.attr("data-tercero", data.id), 
        ...
        terceroChanged: function(e) {
            ...
            this.$inputOrden = this.$("#" + this.$inputContent.attr("data-orden2")), this.$btnContact.length > 0 && (this.$btnContact.attr("data-tercero", ""), 
            this.$btnContact.attr("data-address-default", ""), this.$btnContact.attr("ata-address-nomenclatura-default", ""), 
            this.$btnContact.attr("data-municipio-default", "")), this.$inputOrden.length > 0 && this.$inputOrden.attr("data-tercero", "");
            ...
            this.$inputName.val(""), _.isUndefined(tercero) || _.isNull(tercero) || "" == tercero || $.ajax({
                ...
                _this.$btnContact.attr("data-municipio-default", resp.tercero_municipio)), _this.$inputOrden.length > 0 && _this.$inputOrden.attr("data-tercero", resp.id));
            }).fail(function(jqXHR, ajaxOptions, thrownError) {
                window.Misc.removeSpinner(_this.$wraperConten), alertify.error(thrownError);
            });
        },
    ...
    app.CreateCotizacionView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !1, this.$el.html(this.template(attributes)), this.$form = this.$("#form-cotizacion"), 
            this.spinner = this.$("#spinner-main"), this.ready();
        },
        ready: function() {
            "function" == typeof window.initComponent.initToUpper && window.initComponent.initToUpper(), 
            "function" == typeof window.initComponent.initValidator && window.initComponent.initValidator(), 
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner(this.spinner), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                this.createCotizacionView instanceof Backbone.View && (this.createCotizacionView.stopListening(), 
                this.createCotizacionView.undelegateEvents()), Backbone.history.navigate(Route.route("cotizaciones.edit", {
                    cotizaciones: resp.id
                }), {
                    trigger: !0
                });
            }
    ...
    app.DetalleCotizacion3ListView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$total = this.$("#total"), this.listenTo(this.collection, "add", this.addOne), 
            this.listenTo(this.collection, "reset", this.addAll), this.listenTo(this.collection, "store", this.storeOne), 
            this.listenTo(this.collection, "request", this.loadSpinner), this.listenTo(this.collection, "sync", this.responseServer), 
            this.collection.fetch({
                data: {
                    cotizacion: this.parameters.dataFilter.cotizacion
                },
                reset: !0
            });
        },
        ...
        addOne: function(cotizacion3Model) {
            ...
            cotizacion3Model.view = view, this.$el.prepend(view.render().el), this.totalize();
        },
        addAll: function() {
        ...
        storeOne: function(data) {
            var _this = this;
            window.Misc.setSpinner(this.parameters.wrapper), new app.Cotizacion3Model().save(data, {
                success: function(model, resp) {
                    if (!_.isUndefined(resp.success)) {
                        window.Misc.removeSpinner(_this.parameters.wrapper);
                        var text = resp.success ? "" : resp.errors;
        ...
        removeOne: function(e) {
            ...
            model instanceof Backbone.Model && model.destroy({
                success: function(model, resp) {
                    if (!_.isUndefined(resp.success)) {
                        if (window.Misc.removeSpinner(_this.parameters.wrapper), !resp.success) return void alertify.error(resp.errors);
                        model.view.remove(), _this.totalize();
                    }
                }
            });
        },
        ...
        responseServer: function(target, resp, opts) {
            window.Misc.removeSpinner(this.parameters.wrapper), window.Misc.clearForm($("#form-cotizacion3"));
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    app.DetalleCotizacionItemView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            return attributes.edit = this.parameters.edit, "" != attributes.cotizacion2_productoc && _.isNull(attributes.materialp_nombre) && this.$el.addClass("bg-aqua"), 
    ...
    app.DetalleCotizacion2ListView = Backbone.View.extend({
        ...
        addOne: function(cotizacion2Model) {
            ...
            cotizacion2Model.view = view, this.$el.append(view.render().el), this.totalize();
        },
        addAll: function() {
            this.$el.find("tbody").html(""), this.collection.forEach(this.addOne, this);
        },
        storeOne: function(data) {
            var _this = this;
            window.Misc.setSpinner(_this.parameters.wrapper), new app.Cotizacion2Model().save(data, {
                success: function(model, resp) {
                    if (!_.isUndefined(resp.success)) {
                        window.Misc.removeSpinner(_this.parameters.wrapper);
                        var text = resp.success ? "" : resp.errors;
        ...
        removeOne: function(e) {
            ...
            model instanceof Backbone.Model && model.destroy({
                success: function(model, resp) {
                    if (window.Misc.removeSpinner(_this.parameters.wrapper), !resp.success) return void alertify.error(resp.errors);
                    model.view.remove(), _this.totalize(), _this.collection.fetch({
                        data: {
                            cotizacion: _this.parameters.dataFilter.cotizacion
                        },
                        reset: !0
                    });
                }
        ...
        totalize: function() {
            var data = this.collection.totalize();
            this.$total.length && this.$total.html(window.Misc.currency(data.total));
        },
        loadSpinner: function(target, xhr, opts) {
            window.Misc.setSpinner(this.parameters.wrapper);
        },
        responseServer: function(target, resp, opts) {
            if (window.Misc.removeSpinner(this.parameters.wrapper), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                this.collection.fetch({
                    data: {
    ...
    app.EditCotizacionView = Backbone.View.extend({
        ...
        initialize: function() {
            this.$modalProducto = $("#modal-producto-component"), this.detalleCotizacion2 = new app.DetalleCotizacion2List(), 
            this.detalleCotizacion3 = new app.DetalleCotizacion3List(), this.listenTo(this.model, "change", this.render), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !0, this.$el.html(this.template(attributes)), this.$wrapperDetalle = this.$("#render-detalle"), 
            this.$wrapperDetalle.html(this.templateFp({})), this.$form = this.$("#form-cotizacion"), 
            this.$nombreC3 = this.$("#cotizacion3_nombre"), this.$valorC3 = this.$("#cotizacion3_valor"), 
            this.spinner = this.$("#spinner-main"), this.referenceViews(), this.ready();
        },
        submitCotizacion: function(e) {
            this.$form.submit();
        },
        ...
        addProducto: function(e) {
            ...
            if (this.call = null, "Producto" == text) this.$modalProducto.find(".modal-title").text("Cotización - " + text), 
            this.$modalProducto.find(".content-modal").html(this.templateCP()), this.call = "P"; else {
                if ("Material" != text) return;
                this.$modalProducto.find(".modal-title").text("Cotización - " + text), this.$modalProducto.find(".content-modal").html(this.templateCM()), 
                this.call = "M";
            }
            this.$modalProducto.modal("show"), this.ready(), this.productosView instanceof Backbone.View && (this.productosView.stopListening(), 
            this.productosView.undelegateEvents()), this.productosView = new app.ProductosView({
        ...
        onStoreItem3: function(e) {
            if (!e.isDefaultPrevented()) {
                e.preventDefault();
                var data = window.Misc.formToJson(e.target);
                data.cotizacion1 = this.model.get("id"), this.detalleCotizacion3.trigger("store", data);
            }
        },
        changeAreap: function(e) {
            var _this = this;
            id = this.$(e.currentTarget).val(), this.$nombreC3.val(""), "undefined" == typeof id || _.isUndefined(id) || _.isNull(id) || "" == id ? _this.$nombreC3.attr("readonly", !1) : $.ajax({
                url: window.Misc.urlFull(Route.route("areasp.show", {
                    areasp: id
                })),
                type: "GET",
                beforeSend: function() {
                ...
                window.Misc.removeSpinner(_this.spinner), _this.$nombreC3.attr("readonly", !0), 
        ...
        cancelCotizacion: function(e) {
            ...
            new window.app.ConfirmWindow({
                parameters: {
                    ...
                    onConfirm: function() {
                        $.ajax({
                            url: window.Misc.urlFull(Route.route("cotizaciones.cancel", {
                                cotizaciones: _this.model.get("id")
                            })),
                            type: "GET",
                            beforeSend: function() {
                                window.Misc.setSpinner(_this.spinner);
                            ...
                            if (window.Misc.removeSpinner(_this.spinner), !_.isUndefined(resp.success)) {
                                var text = resp.success ? "" : resp.errors;
                                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                                window.Misc.successRedirect(resp.msg, window.Misc.urlFull(Route.route("cotizaciones.show", {
                                    cotizaciones: _this.model.get("id")
                                })));
                            }
                        }).fail(function(jqXHR, ajaxOptions, thrownError) {
        ...
        approveCotizacion: function(e) {
            ...
            new window.app.ConfirmWindow({
                parameters: {
                    ...
                    onConfirm: function() {
                        $.ajax({
                            url: window.Misc.urlFull(Route.route("cotizaciones.approve", {
                                cotizaciones: _this.model.get("id")
                            })),
                            type: "GET",
                            beforeSend: function() {
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner(this.spinner), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                window.Misc.redirect(window.Misc.urlFull(Route.route("cotizaciones.edit", {
                    cotizaciones: resp.id
                })));
            }
        }
    ...
    app.MainCotizacionesView = Backbone.View.extend({
        ...
        initialize: function() {
            var _this = this;
            this.$cotizacionesSearchTable = this.$("#cotizaciones-search-table"), this.$searchcotizacionCodigo = this.$("#searchcotizacion_numero"), 
            this.$searchcotizacionEstado = this.$("#searchcotizacion_estado"), this.$searchcotizacionTercero = this.$("#searchcotizacion_tercero"), 
            ...
            this.cotizacionesSearchTable = this.$cotizacionesSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.persistent = !0, data.cotizacion_numero = _this.$searchcotizacionCodigo.val(), 
                        data.estado = _this.$searchcotizacionEstado.val(), data.tercero_nit = _this.$searchcotizacionTercero.val(), 
                        data.tercero_nombre = _this.$searchcotizacionTerceroNombre.val();
                    }
                },
                columns: [ {
                    data: "cotizacion_codigo",
                    name: "cotizacion_codigo"
                }, {
                    data: "cotizacion1_ano",
                    name: "cotizacion1_ano"
                }, {
                    data: "cotizacion1_numero",
                    name: "cotizacion1_numero"
                }, {
                    data: "tercero_nombre",
                    name: "tercero_nombre"
                }, {
                    data: "cotizacion1_fecha",
                    name: "cotizacion1_fecha"
                }, {
                    data: "cotizacion1_entrega",
                    name: "cotizacion1_entrega"
                } ],
                order: [ [ 1, "desc" ], [ 2, "desc" ] ],
                columnDefs: [ {
                    targets: 0,
                    width: "5%",
                    render: function(data, type, full, row) {
                        return '<a href="' + window.Misc.urlFull(Route.route("cotizaciones.show", {
                            cotizaciones: full.id
                        })) + '">' + data + "</a>";
                    }
                }, {
                    targets: [ 1, 2 ],
                ...
                fnRowCallback: function(row, data) {
                    parseInt(data.cotizacion1_aprobada) ? $(row).css({
                        color: "#00a65a"
                    }) : parseInt(data.cotizacion1_anulada) ? $(row).css({
                        color: "red"
                    }) : $(row).css({
                        color: "black"
                    });
        ...
        search: function(e) {
            e.preventDefault(), this.cotizacionesSearchTable.ajax.reload();
        },
        clear: function(e) {
            e.preventDefault(), this.$searchcotizacionCodigo.val(""), this.$searchcotizacionEstado.val(""), 
            this.$searchcotizacionTercero.val(""), this.$searchcotizacionTerceroNombre.val(""), 
    ...
    app.ProductosView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$modalProducto = $("#modal-producto-component"), this.$material = this.$("#cotizacion2_materialp"), 
            this.$productoc = this.$("#cotizacion2_productoc"), "M" == this.parameters.call && this.changeProducto(this.parameters.cotizacion), 
            this.listenTo(this.collection, "sync", this.responseServer);
        },
        addProducto: function(e) {
            if (!e.isDefaultPrevented()) {
                e.preventDefault();
                var data = window.Misc.formToJson(e.target);
                data.cotizacion1 = this.parameters.cotizacion, this.collection.trigger("store", data);
            }
        },
        changeTipomaterial: function(e) {
            var _this = this, tipo = this.$(e.currentTarget).val();
            void 0 === tipo || _.isUndefined(tipo) || _.isNull(tipo) || "" == tipo || $.ajax({
                ...
                window.Misc.removeSpinner(_this.el), _this.$material.empty().val(0), _this.$material.append("<option value=></option>"), 
        ...
        changeProducto: function(id) {
            var _this = this;
            $.ajax({
                url: window.Misc.urlFull(Route.route("cotizaciones.detalle.index", {
                    cotizacion_id: id
                })),
                type: "GET",
                beforeSend: function() {
                ...
                window.Misc.removeSpinner(_this.el), _this.$productoc.empty().val(0), _this.$productoc.append("<option value=></option>"), 
        ...
        responseServer: function(model, resp, opts) {
            _.isUndefined(resp.success) || resp.success && (this.productosView instanceof Backbone.View && (this.productosView.stopListening(), 
            this.productosView.undelegateEvents()), this.$modalProducto.modal("hide"));
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    app.ShowCotizacionView = Backbone.View.extend({
        ...
        initialize: function() {
            this.model.id != undefined && (this.detalleCotizacion2 = new app.DetalleCotizacion2List(), 
            this.detalleCotizacion3 = new app.DetalleCotizacion3List(), this.referenceViews());
        },
        referenceViews: function() {
            this.detalleCotizacion2ListView = new app.DetalleCotizacion2ListView({
                collection: this.detalleCotizacion2,
        ...
        openCotizacion: function(e) {
            ...
            new window.app.ConfirmWindow({
                parameters: {
                    ...
                    onConfirm: function() {
                        $.ajax({
                            url: window.Misc.urlFull(Route.route("cotizaciones.open", {
                                cotizaciones: _this.model.get("id")
                            })),
                            type: "GET",
                            beforeSend: function() {
                            ...
                            if (window.Misc.removeSpinner(_this.el), !_.isUndefined(resp.success)) {
                                var text = resp.success ? "" : resp.errors;
                                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                                window.Misc.successRedirect(resp.msg, window.Misc.urlFull(Route.route("cotizaciones.edit", {
                                    cotizaciones: _this.model.get("id")
                                })));
                            }
                        }).fail(function(jqXHR, ajaxOptions, thrownError) {
...
!function($, window, document, undefined) {
    ...
    app.CreateFacturaView = Backbone.View.extend({
        ...
        parameters: {},
        initialize: function() {
            this.$wraperForm = this.$("#render-form-factura"), this.detalleFactura2List = new app.DetalleFactura2List(), 
            this.listenTo(this.model, "change", this.render), this.listenTo(this.model, "sync", this.responseServer), 
            this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            var attributes = this.model.toJSON();
            this.$wraperForm.html(this.template(attributes)), this.$renderDetail = this.$("#render-detail"), 
            this.$renderDetail.html(this.templateDetail({})), this.$form = this.$("#form-factura"), 
            this.$formDetail = this.$("#form-detail-factura"), this.referenceView(), this.ready();
        },
        ...
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
                e.preventDefault();
                var data = window.Misc.formToJson(e.target);
                data.detail = window.Misc.formToJson(this.$formDetail), this.model.save(data, {
                    patch: !0,
                    silent: !0
                });
            }
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner(this.el), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                this.createFacturaView instanceof Backbone.View && (this.createFacturaView.stopListening(), 
                this.createFacturaView.undelegateEvents()), window.Misc.redirect(window.Misc.urlFull(Route.route("facturas.show", {
                    facturas: resp.id
                })));
            }
        }
    ...
    app.DetalleFacturaItemView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            "show" == this.parameters.call && (this.template = _.template($("#add-factura-item-tpl").html() || "")), 
            this.listenTo(this.model, "change", this.render);
        },
        render: function() {
            var attributes = this.model.toJSON();
    ...
    app.DetalleFacturaView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.confCollection = {
                reset: !0,
                data: {}
            }, this.$facturado = this.$("#subtotal-facturado"), this.listenTo(this.collection, "add", this.addOne), 
            this.listenTo(this.collection, "reset", this.addAll), this.listenTo(this.collection, "store", this.storeOne), 
            this.listenTo(this.collection, "request", this.loadSpinner), this.listenTo(this.collection, "sync", this.responseServer), 
            _.isUndefined(this.parameters.dataFilter) || _.isNull(this.parameters.dataFilter) || (this.confCollection.data = this.parameters.dataFilter, 
            this.collection.fetch(this.confCollection));
        },
        addOne: function(factura2Model) {
            ...
            factura2Model.view = view, this.$el.append(view.render().el), this.totalize();
        },
        addAll: function() {
            this.$el.find("tbody").html(""), this.collection.forEach(this.addOne, this);
        },
        storeOne: function(data) {
            var _this = this, result = this.collection.validar(data);
            if (!result.success) return void alertify.error(result.error);
            window.Misc.setSpinner(this.el), new app.Factura2Model().save(data, {
                success: function(model, resp) {
                    if (!_.isUndefined(resp.success)) {
                ...
                error: function(model, error) {
                    window.Misc.removeSpinner(_this.el), alertify.error(error.statusText);
                }
            });
        },
        removeOne: function(e) {
        ...
        totalize: function() {
            var data = this.collection.totalize();
            this.$facturado.length && this.$facturado.html(data.facturado);
        },
        loadSpinner: function(target, xhr, opts) {
            window.Misc.setSpinner(this.el);
        },
        responseServer: function(target, resp, opts) {
            if (window.Misc.removeSpinner(this.el), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                $("#factura1_orden").val(""), $("#factura1_orden_beneficiario").val("");
            }
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    app.MainFacturasView = Backbone.View.extend({
        ...
        initialize: function() {
            var _this = this;
            this.$facturasSearchTable = this.$("#facturas-search-table"), this.$searchfacturaNumero = this.$("#searchfactura_numero"), 
            this.$searchfacturaTercero = this.$("#searchfactura_tercero"), this.$searchfacturaTerceroNombre = this.$("#searchfactura_tercero_nombre"), 
            this.facturasSearchTable = this.$facturasSearchTable.DataTable({
                ...
                ajax: {
                    url: window.Misc.urlFull(Route.route("facturas.index")),
                    data: function(data) {
                        data.persistent = !0, data.id = _this.$searchfacturaNumero.val(), data.tercero_nit = _this.$searchfacturaTercero.val(), 
                ...
                columnDefs: [ {
                    ...
                    width: "5%",
                    render: function(data, type, full, row) {
                        return '<a href="' + window.Misc.urlFull(Route.route("facturas.show", {
                            facturas: full.id
                        })) + '">' + data + "</a>";
                    }
                } ]
        ...
        search: function(e) {
            e.preventDefault(), this.facturasSearchTable.ajax.reload();
        },
        clear: function(e) {
            e.preventDefault(), this.$searchfacturaNumero.val(""), this.$searchfacturaTercero.val(""), 
            this.$searchfacturaTerceroNombre.val(""), this.facturasSearchTable.ajax.reload();
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    app.ShowFacturaView = Backbone.View.extend({
        ...
        initialize: function() {
            this.model.id != undefined && (this.detalleFactura2List = new app.DetalleFactura2List(), 
            this.referenceViews());
        },
        referenceViews: function() {
            this.detalleFacturaView = new app.DetalleFacturaView({
        ...
        exportFactura: function(e) {
            e.preventDefault(), window.open(window.Misc.urlFull(Route.route("facturas.exportar", {
                facturas: this.model.get("id")
            })));
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    ...
    app.DetalleFacturapView = Backbone.View.extend({
        ...
        addOne: function(facturap2Model) {
            ...
            facturap2Model.view = view, this.$el.append(view.render().el);
        },
        addAll: function() {
            this.collection.forEach(this.addOne, this);
        },
    ...
    app.MainFacturaspView = Backbone.View.extend({
        ...
        initialize: function() {
            var _this = this;
            this.$facturaspSearchTable = this.$("#facturasp-search-table"), this.$searchfacturapReferencia = this.$("#searchfacturap_referencia"), 
            this.$searchfacturapFecha = this.$("#searchfacturap_fecha"), this.$searchfacturapTercero = this.$("#searchfacturap_tercero"), 
            this.$searchfacturapTerceroNombre = this.$("#searchfacturap_tercero_nombre"), this.facturaspSearchTable = this.$facturaspSearchTable.DataTable({
                dom: "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                processing: !0,
                serverSide: !0,
                language: window.Misc.dataTableES(),
                ajax: {
                    ...
                    data: function(data) {
                        data.persistent = !0, data.referencia = _this.$searchfacturapReferencia.val(), data.facturap_fecha = _this.$searchfacturapFecha.val(), 
                        data.tercero_nit = _this.$searchfacturapTercero.val(), data.tercero_nombre = _this.$searchfacturapTerceroNombre.val();
                    }
                },
                columns: [ {
                    data: "id",
                    ...
                    data: "facturap1_factura",
                    name: "facturap1_factura"
                }, {
                    data: "facturap1_fecha",
                    name: "facturap1_fecha"
                } ],
                columnDefs: [ {
                    targets: 0,
                    width: "5%",
                    render: function(data, type, full, row) {
                        return '<a href="' + window.Misc.urlFull(Route.route("facturap.show", {
                            facturap: full.id
                        })) + '">' + data + "</a>";
                    }
                } ]
        ...
        search: function(e) {
            e.preventDefault(), this.facturaspSearchTable.ajax.reload();
        },
        clear: function(e) {
            e.preventDefault(), this.$searchfacturapReferencia.val(""), this.$searchfacturapFecha.val(""), 
            this.$searchfacturapTercero.val(""), this.$searchfacturapTerceroNombre.val(""), 
    ...
    app.ShowFacturapView = Backbone.View.extend({
        el: "#facturap-show",
        initialize: function() {
            this.model.id != undefined && (this.cuotasFPList = new app.CuotasFPList(), this.referenceViews());
        },
        referenceViews: function() {
    ...
    app.CreateOrdenpView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !1, this.$el.html(this.template(attributes)), this.$form = this.$("#form-ordenes"), 
            this.spinner = this.$("#spinner-main"), this.ready();
        },
    ...
    app.EditOrdenpView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.productopOrdenList = new app.ProductopOrdenList(), this.despachopOrdenList = new app.DespachopOrdenList(), 
            this.despachospPendientesOrdenList = new app.DespachospPendientesOrdenList(), this.listenTo(this.model, "change", this.render), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !0, this.$el.html(this.template(attributes)), this.$product = this.$("#productop"), 
            this.$form = this.$("#form-ordenes"), this.spinner = this.$("#spinner-main"), this.referenceViews(), 
            this.ready();
        },
        referenceViews: function() {
        ...
        changeTypeProduct: function(e) {
            var _this = this, typeproduct = this.$(e.currentTarget).val();
            void 0 === typeproduct || _.isUndefined(typeproduct) || _.isNull(typeproduct) || "" == typeproduct || $.ajax({
                ...
                window.Misc.removeSpinner(_this.spinner), _this.$product.empty().val(0), _this.$product.append("<option value=></option>"), 
                _.each(resp.data, function(item) {
    ...
    app.MainOrdenesView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.$searchordenpProductop = this.$("#searchordenp_ordenp_productop"), this.ordersSearchTable = this.$ordersSearchTable.DataTable({
                ...
                fnRowCallback: function(row, data) {
                    parseInt(data.orden_abierta) ? $(row).css({
                        color: "#00a65a"
                    }) : parseInt(data.orden_anulada) && $(row).css({
                        color: "red"
                    });
                }
            });
    ...
    app.ProductopOrdenListView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$unidades = this.$("#subtotal-cantidad"), this.$facturado = this.$("#subtotal-facturado"), 
            this.$subtotal = this.$("#subtotal-total"), this.$iva = this.$("#iva-total"), this.$total = this.$("#total-total"), 
            this.listenTo(this.collection, "add", this.addOne), this.listenTo(this.collection, "reset", this.addAll), 
            this.listenTo(this.collection, "request", this.loadSpinner), this.listenTo(this.collection, "sync", this.responseServer), 
            this.collection.fetch({
                data: {
        ...
        totalize: function() {
            var data = this.collection.totalize();
            this.$unidades.length && this.$unidades.html(data.unidades), this.$facturado.length && this.$facturado.html(data.facturado), 
            this.$subtotal.length && this.$subtotal.html(window.Misc.currency(data.subtotal));
    ...
    app.CreateProductopView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !1, this.$el.html(this.template(attributes)), this.$inputAbierto = $("#productop_abierto"), 
            this.$inputAbiertoAncho = $("#productop_ancho_med"), this.$inputAbiertoAlto = $("#productop_alto_med"), 
            this.$inputCerrado = $("#productop_cerrado"), this.$inputCerradoAncho = $("#productop_c_med_ancho"), 
            this.$inputCerradoAlto = $("#productop_c_med_alto"), this.$input3d = $("#productop_3d"), 
            this.$input3dAncho = $("#productop_3d_ancho_med"), this.$input3dAlto = $("#productop_3d_alto_med"), 
            this.$input3dProfundidad = $("#productop_3d_profundidad_med"), this.$form = this.$("#form-productosp"), 
            this.spinner = this.$("#spinner-main"), this.ready();
        },
    ...
    app.EditProductopView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.tipsList = new app.TipsList(), this.areasList = new app.AreasList(), this.maquinasList = new app.MaquinasList(), 
        ...
        render: function() {
            var attributes = this.model.toJSON();
            attributes.edit = !0, this.$el.html(this.template(attributes)), this.$form = this.$("#form-productosp"), 
            this.spinner = this.$("#spinner-main"), this.$inputAbierto = $("#productop_abierto"), 
            this.$inputAbiertoAncho = $("#productop_ancho_med"), this.$inputAbiertoAlto = $("#productop_alto_med"), 
            this.$inputCerrado = $("#productop_cerrado"), this.$inputCerradoAncho = $("#productop_c_med_ancho"), 
            this.$inputCerradoAlto = $("#productop_c_med_alto"), this.$input3d = $("#productop_3d"), 
            this.$input3dAncho = $("#productop_3d_ancho_med"), this.$input3dAlto = $("#productop_3d_alto_med"), 
            this.$input3dProfundidad = $("#productop_3d_profundidad_med"), this.referenceViews(), 
            this.ready();
        },
        referenceViews: function() {
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner(this.spinner), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                window.Misc.redirect(window.Misc.urlFull(Route.route("productosp.show", {
                    productosp: resp.id
                })));
            }
        }
    ...
    app.CreateTipoProductopView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$wraperForm = this.$("#render-form-tipoproductop"), this.listenTo(this.model, "change", this.render), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.model, "request", this.loadSpinner);
        },
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
    ...
    app.MainTipoProductospView = Backbone.View.extend({
        ...
        initialize: function() {
            this.$tipoproductospSearchTable = this.$("#tipoproductosp-search-table"), this.$tipoproductospSearchTable.DataTable({
                dom: "<'row'<'col-sm-4'B><'col-sm-4 text-center'l><'col-sm-4'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                processing: !0,
                serverSide: !0,
                language: window.Misc.dataTableES(),
                ...
                columns: [ {
                    ...
                    data: "tipoproductop_nombre",
                    name: "tipoproductop_nombre"
                }, {
                    data: "tipoproductop_activo",
                    name: "tipoproductop_activo"
                } ],
                buttons: [ {
                ...
                columnDefs: [ {
                    ...
                    width: "10%",
                    render: function(data, type, full, row) {
                        return '<a href="' + window.Misc.urlFull(Route.route("tipoproductosp.show", {
                            tipoproductosp: full.id
                        })) + '">' + data + "</a>";
                    }
                }, {
                    targets: [ 2 ],
    ...
    app.CreateTipoMaterialpView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$wraperForm = this.$("#render-form-tipomaterialp"), this.listenTo(this.model, "change", this.render), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.model, "request", this.loadSpinner);
        },
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
        ...
        responseServer: function(model, resp, opts) {
            if (window.Misc.removeSpinner(this.el), !_.isUndefined(resp.success)) {
                var text = resp.success ? "" : resp.errors;
                if (_.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), !resp.success) return void alertify.error(text);
                window.Misc.clearForm(this.$("#form-tipomaterialp")), window.Misc.redirect(window.Misc.urlFull(Route.route("tiposmaterialp.index")));
            }
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    app.MainTiposMaterialpView = Backbone.View.extend({
        ...
        initialize: function() {
            this.$tiposmaterialpSearchTable = this.$("#tiposmaterialp-search-table"), this.$tiposmaterialpSearchTable.DataTable({
                dom: "<'row'<'col-sm-4'B><'col-sm-4 text-center'l><'col-sm-4'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                processing: !0,
                serverSide: !0,
                language: window.Misc.dataTableES(),
                ...
                columns: [ {
                    ...
                    data: "tipomaterial_nombre",
                    name: "tipomaterial_nombre"
                }, {
                    data: "tipomaterial_activo",
                    name: "tipomaterial_activo"
                } ],
                buttons: [ {
                ...
                columnDefs: [ {
                    ...
                    width: "10%",
                    render: function(data, type, full, row) {
                        return '<a href="' + window.Misc.urlFull(Route.route("tiposmaterialp.show", {
                            tiposmaterialp: full.id
                        })) + '">' + data + "</a>";
                    }
                }, {
                    targets: [ 2 ],
    ...
    app.DetalleFactura2List = Backbone.Collection.extend({
        ...
        validar: function(data) {
            ...
            }) instanceof Backbone.Model ? (response.error = "La orden No. " + data.factura1_orden + " ya se encuentra registrada.", 
            response) : (response.success = !0, response);
        },
...
!function(window, document, undefined) {
    ...
    app.AppRouter = new (Backbone.Router.extend({
        ...
        initialize: function(opts) {
            ...
            this.componentSearchOrdenP2View = new app.ComponentSearchOrdenP2View(), this.componentSearchProductoView = new app.ComponentSearchProductoView(), 
            this.componentSearchContactoView = new app.ComponentSearchContactoView(), this.componentConsecutiveView = new app.ComponentConsecutiveView();
        },
        start: function() {
            var config = {
                pushState: !0
        ...
        getTiposMaterialpMain: function() {
            this.mainTiposMaterialpView instanceof Backbone.View && (this.mainTiposMaterialpView.stopListening(), 
            this.mainTiposMaterialpView.undelegateEvents()), this.mainTiposMaterialpView = new app.MainTiposMaterialpView();
        },
        getTiposMaterialpCreate: function() {
            this.tipomaterialpModel = new app.TipoMaterialpModel(), this.createTipoMaterialpView instanceof Backbone.View && (this.createTipoMaterialpView.stopListening(), 
        ...
        getTiposMaterialpEdit: function(tipomaterialp) {
            this.tipomaterialpModel = new app.TipoMaterialpModel(), this.tipomaterialpModel.set({
                id: tipomaterialp
            }, {
                silent: !0
            }), this.createTipoMaterialpView instanceof Backbone.View && (this.createTipoMaterialpView.stopListening(), 
            this.createTipoMaterialpView.undelegateEvents()), this.createTipoMaterialpView = new app.CreateTipoMaterialpView({
                model: this.tipomaterialpModel
            }), this.tipomaterialpModel.fetch();
        },
        getTipoProductopMain: function() {
            this.mainTipoProductospView instanceof Backbone.View && (this.mainTipoProductospView.stopListening(), 
            this.mainTipoProductospView.undelegateEvents()), this.mainTipoProductospView = new app.MainTipoProductospView();
        },
        getTipoProductopCreate: function() {
            this.tipoproductopModel = new app.TipoProductopModel(), this.createTipoProductopView instanceof Backbone.View && (this.createTipoProductopView.stopListening(), 
            this.createTipoProductopView.undelegateEvents()), this.createTipoProductopView = new app.CreateTipoProductopView({
                model: this.tipoproductopModel
            }), this.createTipoProductopView.render();
        },
        getTipoProductopEdit: function(tipoproductosp) {
            this.tipoproductopModel = new app.TipoProductopModel(), this.tipoproductopModel.set({
                id: tipoproductosp
            }, {
                silent: !0
            }), this.createTipoProductopView instanceof Backbone.View && (this.createTipoProductopView.stopListening(), 
            this.createTipoProductopView.undelegateEvents()), this.createTipoProductopView = new app.CreateTipoProductopView({
                model: this.tipoproductopModel
        ...
        getOrdenesEdit: function(orden) {
            ...
            this.createOrdenpView.undelegateEvents()), this.editOrdenpView instanceof Backbone.View && (this.editOrdenpView.stopListening(), 
            this.editOrdenpView.undelegateEvents()), this.editOrdenpView = new app.EditOrdenpView({
                model: this.ordenpModel
        ...
        getProductospEdit: function(producto) {
            ...
            this.createProductopView.undelegateEvents()), this.editProductopView instanceof Backbone.View && (this.editProductopView.stopListening(), 
            this.editProductopView.undelegateEvents()), this.editProductopView = new app.EditProductopView({
                model: this.productopModel
            }), this.productopModel.fetch();
        },
        getCotizacionesMain: function() {
            this.mainCotizacionesView instanceof Backbone.View && (this.mainCotizacionesView.stopListening(), 
            this.mainCotizacionesView.undelegateEvents()), this.mainCotizacionesView = new app.MainCotizacionesView();
        },
        getCotizacionesCreate: function() {
            this.cotizacionModel = new app.CotizacionModel(), this.createCotizacionView instanceof Backbone.View && (this.createCotizacionView.stopListening(), 
            this.createCotizacionView.undelegateEvents()), this.createCotizacionView = new app.CreateCotizacionView({
                model: this.cotizacionModel
            }), this.createCotizacionView.render();
        },
        getCotizacionesShow: function(cotizacion) {
            this.cotizacionModel = new app.CotizacionModel(), this.cotizacionModel.set({
                id: cotizacion
            }, {
                silent: !0
            }), this.showCotizacionView instanceof Backbone.View && (this.showCotizacionView.stopListening(), 
            this.showCotizacionView.undelegateEvents()), this.showCotizacionView = new app.ShowCotizacionView({
                model: this.cotizacionModel
            });
        },
        getCotizacionesEdit: function(cotizacion) {
            this.cotizacionModel = new app.CotizacionModel(), this.cotizacionModel.set({
                ...
                silent: !0
            }), this.editCotizacionView instanceof Backbone.View && (this.editCotizacionView.stopListening(), 
            this.editCotizacionView.undelegateEvents()), this.createCotizacionView instanceof Backbone.View && (this.createCotizacionView.stopListening(), 
            this.createCotizacionView.undelegateEvents()), this.editCotizacionView = new app.EditCotizacionView({
                model: this.cotizacionModel
            }), this.cotizacionModel.fetch();
        },
        getFacturasMain: function() {
            this.mainFacturaView instanceof Backbone.View && (this.mainFacturaView.stopListening(), 
            this.mainFacturaView.undelegateEvents()), this.mainFacturaView = new app.MainFacturasView();
        },
        getFacturaCreate: function() {
            this.facturaModel = new app.FacturaModel(), this.createFacturaView instanceof Backbone.View && (this.createFacturaView.stopListening(), 
            this.createFacturaView.undelegateEvents()), this.createFacturaView = new app.CreateFacturaView({
                model: this.facturaModel
            }), this.createFacturaView.render();
        },
        getFacturaShow: function(facturas) {
            this.facturaModel = new app.FacturaModel(), this.facturaModel.set({
                id: facturas
            }, {
                silent: !0
            }), this.showFacturasView instanceof Backbone.View && (this.showFacturasView.stopListening(), 
            this.showFacturasView.undelegateEvents()), this.showFacturasView = new app.ShowFacturaView({
                model: this.facturaModel
            });
        },
        getFacturaspMain: function() {
            this.mainFacturaspView instanceof Backbone.View && (this.mainFacturaspView.stopListening(), 
            this.mainFacturaspView.undelegateEvents()), this.mainFacturaspView = new app.MainFacturaspView();
        },
        getFacturaspShow: function(facturap) {
            this.facturapModel = new app.FacturapModel(), this.facturapModel.set({
                id: facturap
            }, {
                silent: !0
            }), this.showFacturapView instanceof Backbone.View && (this.showFacturapView.stopListening(), 
            this.showFacturapView.undelegateEvents()), this.showFacturapView = new app.ShowFacturapView({
