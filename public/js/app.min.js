/*! koi-frontend - v1.0.0 - 2017-03-24 */
!function($, window, document, undefined) {
    ...
    app.ComponentAddressView = Backbone.View.extend({
        ...
        addAddress: function(e) {
            ...
            this.$modalComponent.modal("hide"), $(".modal.in").length > 0 && setTimeout(function() {
        ...
        ChangeSelect: function(e) {
            ...
            if ("si" == $(e.target).val()) _this.$component.show(), $("input#component-input-text").change(function() {
                ...
                _this.$modalComponentValidacion.modal("hide"), setTimeout(function() {
                    _this.$el.addClass("modal-open");
                }, 500);
            }); else {
            ...
            _this.$modalComponent.length > 0 && setTimeout(function() {
                _this.$el.addClass("modal-open");
            }, 500);
        },
...
!function($, window, document, undefined) {
    ...
    app.CreateTerceroView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.$username = this.$("#username"), this.$password = this.$("#password"), this.$password_confirmation = this.$("#password_confirmation"), 
