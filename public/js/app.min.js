/*! koi-frontend - v1.0.0 - 2017-07-07 */
!function($, window, document, undefined) {
        ...
        searchFactura: function(e) {
            ...
            this.$factura = this.$inputContent.attr("data-factura"), this.facturaSearchTable = this.$facturaSearchTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        data.id = _this.$searchfacturaNumero.val(), data.orden_codigo = _this.$searchfacturaOrdenp.val(), 
    ...
    app.CreateFacturaView = Backbone.View.extend({
        ...
        render: function() {
            var attributes = this.model.toJSON();
            this.$wraperForm.html(this.template(attributes)), this.$form = this.$("#form-factura1"), 
            this.ready();
        },
        onStore: function(e) {
            if (!e.isDefaultPrevented()) {
        ...
        changeOrden: function(e) {
            this.$ordenp_codigo = this.$(e.currentTarget).val(), this.detalleFacturaView = new app.DetalleFacturaView({
        ...
        responseServer: function(model, resp, opts) {
            ...
            window.Misc.redirect(window.Misc.urlFull(Route.route("facturas.show", {
                facturas: resp.id
            })));
        }
    });
...
!function($, window, document, undefined) {
    ...
    app.DetalleFacturaView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.listenTo(this.collection, "sync", this.responseServer), _.isUndefined(this.parameters.dataFilter) || _.isNull(this.parameters.dataFilter) || (this.confCollection.data = this.parameters.dataFilter, 
            this.collection.fetch(this.confCollection));
        },
        ...
        initialize: function() {
            ...
            this.facturasSearchTable = this.$facturasSearchTable.DataTable({
                ...
                ajax: {
                    url: window.Misc.urlFull(Route.route("facturas.index")),
                    data: function(data) {
                        data.persistent = !0, data.id = _this.$searchfacturaNumero.val(), data.orden_codigo = _this.$searchfacturaOrdenp.val(), 
                        data.orden_tercero = _this.$searchfacturaOrdenpBeneficiario.val(), data.tercero_nit = _this.$searchfacturaTercero.val(), 
                ...
                columns: [ {
                    ...
                    data: "orden_beneficiario",
                    name: "orden_beneficiario"
                }, {
