...
!function($, window, document, undefined) {
    ...
    Misc.prototype = {
        ...
        multiModal: function(modal) {
            $(modal).length > 0 && setTimeout(function() {
    ...
    app.AsientoActionView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            console.log(this.parameters), this.$modalOp = this.$("#modal-asiento-ordenp-component"), 
            this.$modalFp = this.$("#modal-asiento-facturap-component"), this.$modalIn = this.$("#modal-asiento-inventario-component"), 
            this.$modalCt = this.$("#modal-asiento-cartera-component"), this.cuotasFPList = new app.CuotasFPList(), 
            this.itemRolloINList = new app.ItemRolloINList(), this.productoSeriesINList = new app.ProductoSeriesINList(), 
            this.facturaList = new app.FacturaList(), this.listenTo(this.cuotasFPList, "reset", this.addAllCuotasFacturap), 
            this.listenTo(this.facturaList, "reset", this.addAllFactura), this.listenTo(this.itemRolloINList, "reset", this.addAllItemRolloInventario), 
            this.listenTo(this.model, "sync", this.responseServer), this.listenTo(this.collection, "sync", this.responseServer);
        },
        render: function() {
            this.runAction();
        },
        ...
        onStoreItemFactura: function(e) {
            e.isDefaultPrevented() || (e.preventDefault(), this.parameters.data = _.assign({}, this.parameters.data, window.Misc.formToJson(e.target)), 
            this.validateAction({
                action: "cartera",
                callback: function(_this) {
                    return function(resp) {
    ...
    app.ComponentSearchOrdenPView = Backbone.View.extend({
        ...
        setOrden: function(e) {
            ...
            "true" == this.$factura && this.$inputContent.val(data.orden_codigo).trigger("change"), 
            this.$modalComponent.modal("hide");
        },
        search: function(e) {
