...
!function($, window, document, undefined) {
    ...
    app.AppRouter = new (Backbone.Router.extend({
        ...
        getFoldersEdit: function(folder) {
            this.FoldersModel = new app.FoldersModel(), this.FoldersModel.set({
                id: folder
            }, {
                silent: !0
            }), this.createFoldersView instanceof Backbone.View && (this.createFoldersView.stopListening(), 
            this.createFoldersView.undelegateEvents()), this.createFoldersView = new app.CreateFoldersView({
                model: this.FoldersModel,
                parameters: {
                    callback: "toShow"
                }
