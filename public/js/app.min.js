/*! koi-frontend - v1.0.0 - 2017-03-01 */
...
app || (app = {}), function($, window, document, undefined) {
    ...
    app.CreateRolView = Backbone.View.extend({
        ...
        changePermissions: function(e) {
            e.preventDefault();
            var resource = $(e.currentTarget).attr("data-resource"), father = $(e.currentTarget).attr("data-father"), model = this.stuffToDo[father].get(resource);
    ...
    app.CreatePermisoRolView = Backbone.View.extend({
        ...
        initialize: function(opts) {},
        render: function() {
            return this.ready(), this.$el.modal("show"), this;
        },
        ready: function() {},
        onStore: function(e) {},
        loadSpinner: function(model, xhr, opts) {},
