...
!function($, window, document, undefined) {
    ...
    Misc.prototype = {
        ...
        cloneOrden: function(options) {
            ...
            settings = $.extend({}, defaults, options), $.ajax({
                ...
                var text = resp.success ? "" : resp.errors;
                return _.isObject(resp.errors) && (text = window.Misc.parseErrors(resp.errors)), 
                resp.success ? void ("Function" === {}.toString.call(settings.callback).slice(8, -1) && settings.callback(resp)) : void alertify.error(text);
            }).fail(function(jqXHR, ajaxOptions, thrownError) {
                window.Misc.removeSpinner(settings.wrap), alertify.error(thrownError);
            });
        }
    ...
    app.CreateOrdenpView = Backbone.View.extend({
        ...
        closeOrdenp: function(e) {
            e.preventDefault();
            var _this = this, cancelConfirm = new window.app.ConfirmWindow({
                parameters: {
                    dataFilter: {
    ...
    app.CreateOrdenp2View = Backbone.View.extend({
        ...
        changedTiro: function(e) {
            ...
            selected ? (this.$inputYellow.iCheck("check"), this.$inputMagenta.iCheck("check"), 
        ...
        changedRetiro: function(e) {
            var selected = $(e.target).is(":checked");
            selected ? (this.$inputYellow2.iCheck("check"), this.$inputMagenta2.iCheck("check"), 
...
app || (app = {}), function($, window, document, undefined) {
    ...
    app.ProductopOrdenListView = Backbone.View.extend({
        ...
        cloneOne: function(e) {
            ...
            }, cloneConfirm = new window.app.ConfirmWindow({
                parameters: {
                    dataFilter: data,
    ...
    app.CreateProductopView = Backbone.View.extend({
        ...
        changedAbierto: function(e) {
            var selected = $(e.target).is(":checked");
            selected ? (this.$input3d.iCheck("uncheck"), this.$input3d.iCheck("disable"), this.$input3dAncho.prop("disabled", !0).val(""), 
            this.$input3dAlto.prop("disabled", !0).val(""), this.$input3dProfundidad.prop("disabled", !0).val("")) : (this.$input3d.iCheck("enable"), 
        ...
        changed3d: function(e) {
            var selected = $(e.target).is(":checked");
            selected ? (this.$inputAbierto.iCheck("uncheck"), this.$inputAbierto.iCheck("disable"), 
    ...
    app.CreateRolView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            opts !== undefined && _.isObject(opts.parameters) && (this.parameters = $.extend({}, this.parameters, opts.parameters)), 
            this.$wraperForm = this.$("#render-form-rol"), this.model.id != undefined && (this.moduloList = new app.ModuloList()), 
            this.listenTo(this.model, "change", this.render), this.listenTo(this.model, "sync", this.responseServer), 
            this.listenTo(this.model, "request", this.loadSpinner);
        },
        render: function() {
            ...
            this.model.id != undefined && this.referenceViews();
        },
        referenceViews: function() {
    ...
    app.ModulosListView = Backbone.View.extend({
        ...
        initialize: function(opts) {
            ...
            this.listenTo(this.collection, "sync", this.responseServer), this.collection.fetch({
                data: {
                    modulo_id: this.parameters.dataFilter.modulo_id
                },
                reset: !0
            });
        },
        ...
        addOne: function(moduloModel) {
            ...
            moduloModel.view = view, this.$el.prepend(view.render().el);
        },
        addAll: function() {
            this.collection.forEach(this.addOne, this);
        },
    ...
    app.ContactItemView = Backbone.View.extend({
        ...
        editContacto: function() {
            ...
            this.createTContactoView.undelegateEvents()), this.createTContactoView = new app.CreateTContactoView({
                model: this.model
            }), console.log(this.createTContactoView), this.createTContactoView.render();
        }
    });
}(jQuery, this, this.document), app || (app = {}), function($, window, document, undefined) {
    ...
    app.CreateTerceroView = Backbone.View.extend({
        ...
        changedTechnical: function(e) {
            var selected = $(e.target).is(":checked");
            selected ? this.$wrapperCoordinador.removeClass("hide") : this.$wrapperCoordinador.addClass("hide");
        },
    ...
    app.ProductopOrdenList = Backbone.Collection.extend({
        ...
        totalize: function() {
            var unidades = this.unidades(), subtotal = this.subtotal();
            return {
                unidades: unidades,
                subtotal: subtotal
            };
