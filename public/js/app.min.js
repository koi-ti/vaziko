/*! koi-frontend - v1.0.0 - 2017-06-08 */
!function($, window, document, undefined) {
    ...
    app.AsientoCuentasItemView = Backbone.View.extend({
        ...
        showInfo: function() {
            ...
            this.$wrapFactura = this.$modalInfo.find("#render-info-factura"), this.$wrapFacturap = this.$modalInfo.find("#render-info-facturap"), 
            this.$wrapInventario = this.$modalInfo.find("#render-info-inventario"), this.asientoMovimientosList.fetch({
                reset: !0,
                data: {
        ...
        addOne: function(AsientoMovModel) {
            ...
            "F" == attributes.movimiento_tipo) this.$wrapFactura.empty().html(this.templateInfoFacturaItem(attributes)), 
            this.$wrapperList = this.$modalInfo.find("#browse-showinfo-factura-list"); else {
                if ("FP" == attributes.movimiento_tipo && !_.isNull(attributes.movimiento_sucursal)) return void this.$wrapFacturap.empty().html(this.templateInfoFacturapItem(attributes));
                "FP" == attributes.movimiento_tipo && _.isNull(attributes.movimiento_sucursal) ? (this.$wrapFacturap.empty().html(this.templateInfoFacturapItem(attributes)), 
                this.$wrapperList = this.$modalInfo.find("#browse-showinfo-facturap-list")) : "IP" == attributes.movimiento_tipo && (this.$wrapInventario.empty().html(this.templateInfoInventarioItem(attributes)), 
