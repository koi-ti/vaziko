...
$.AdminLTE = {}, $.AdminLTE.options = {
        ...
        return function() {
                ...
                !function(b) {
                    ...
                    function f(a, b) {
                        ...
                        if (a && "." === a.charAt(0)) if (b) {
                            for (n = n.slice(0, n.length - 1), a = a.split("/"), g = a.length - 1, s.nodeIdCompat && w.test(a[g]) && (a[g] = a[g].replace(w, "")), 
                            a = n.concat(a), k = 0; k < a.length; k += 1) if (m = a[k], "." === m) a.splice(k, 1), 
                            k -= 1; else if (".." === m) {
            ...
            return b.Extend(c, b.Observable), c.prototype.render = function() {
                ...
                this.$results.attr("id", d), b.on("results:all", function(a) {
                    ...
                    c.$results.attr("aria-expanded", "true"), c.$results.attr("aria-hidden", "false"), 
                    c.setClasses(), c.ensureHighlightVisible();
                }), b.on("close", function() {
                    c.$results.attr("aria-expanded", "false"), c.$results.attr("aria-hidden", "true"), 
                    ...
                    e ? (c.$results.scrollTop(0), a.preventDefault(), a.stopPropagation()) : f && (c.$results.scrollTop(c.$results.get(0).scrollHeight - c.$results.height()), 
            ...
            return b.Extend(d, b.Observable), d.prototype.render = function() {
                ...
                this.container = a, this.$selection.on("focus", function(a) {
                    ...
                    b.$selection.attr("aria-expanded", "false"), b.$selection.removeAttr("aria-activedescendant"), 
                    b.$selection.removeAttr("aria-owns"), b.$selection.focus(), b._detachCloseHandler(a);
            ...
            return c.Extend(d, b), d.prototype.render = function() {
                ...
                this.$selection.find(".select2-selection__rendered").attr("id", c), this.$selection.attr("aria-labelledby", c), 
                this.$selection.on("mousedown", function(a) {
                    1 === a.which && b.trigger("toggle", {
                        originalEvent: a
                    });
                }), this.$selection.on("focus", function() {}), this.$selection.on("blur", function() {}), 
                a.on("selection:update", function(a) {
                    b.update(a.data);
                });
            ...
            function d(b, c) {
                this.ajaxOptions = this._applyDefaults(c.get("ajax")), null != this.ajaxOptions.processResults && (this.processResults = this.ajaxOptions.processResults), 
            ...
            return b.Extend(d, a), d.prototype._applyDefaults = function(a) {
                ...
                "function" == typeof f.url && (f.url = f.url(a)), "function" == typeof f.data && (f.data = f.data(a)), 
            ...
            D.prototype.apply = function(l) {
                if (l = a.extend({}, this.defaults, l), null == l.dataAdapter) {
                    if (l.dataAdapter = null != l.ajax ? o : null != l.data ? n : m, l.minimumInputLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, r)), 
                    l.maximumInputLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, s)), l.maximumSelectionLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, t)), 
                ...
                if (null == l.selectionAdapter) {
                    if (l.selectionAdapter = l.multiple ? e : d, null != l.placeholder && (l.selectionAdapter = j.Decorate(l.selectionAdapter, f)), 
            ...
            return c.Extend(e, c.Observable), e.prototype._generateId = function(a) {
                ...
                this.on("open", function() {
                    ...
                    var c = b.which;
                    a.isOpen() ? c === d.ENTER ? (a.trigger("results:select"), b.preventDefault()) : c === d.SPACE && b.ctrlKey ? (a.trigger("results:toggle"), 
                    b.preventDefault()) : c === d.UP ? (a.trigger("results:previous"), b.preventDefault()) : c === d.DOWN ? (a.trigger("results:next"), 
                    b.preventDefault()) : (c === d.ESC || c === d.TAB) && (a.close(), b.preventDefault()) : (c === d.ENTER || c === d.SPACE || (c === d.DOWN || c === d.UP) && b.altKey) && (a.open(), 
                    b.preventDefault());
                });
    ...
    function generateMaskSets(opts) {
        function getMaskTemplate(mask) {
            ...
            for (var singleMask = $.map(mask.split(""), function(element, index) {
                var outElem = [];
    ...
    function maskScope(masksets, activeMasksetIndex, opts, actionObj) {
        ...
        function isValid(pos, c, strict) {
            ...
            function PostProcessResults(maskForwards, results) {
                ...
                }), hasValidActual) results = $.map(results, function(rslt, ndx) {
    ...
    $.extend($.inputmask.defaults.definitions, {
        ...
        "dd/mm/yyyy": {
            ...
            isInYearRange: function(chrs, minyear, maxyear) {
                ...
                return (NaN != enteredyear ? enteredyear >= minyear && maxyear >= enteredyear : !1) || (NaN != enteredyear2 ? enteredyear2 >= minyear && maxyear >= enteredyear2 : !1);
            },
    ...
    function N(a, b, c, d) {
        ...
        (c || !a.oFeatures.bDeferRender) && Ja(a, e, c, d), e;
    }
    function ma(a, b) {
        var c;
    ...
    function Ja(a, b, c, d) {
        ...
        if (null === e.nTr) {
            ...
            Na(a, e), l = 0, q = a.aoColumns.length; q > l; l++) n = a.aoColumns[l], i = c ? d[l] : I.createElement(n.sCellType), 
            i._DT_CellIndex = {
                row: b,
                column: l
    ...
    function O(a) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1); else {
            ...
            if (0 !== i.length) for (f = j ? a.aoData.length : n, j = j ? 0 : g; f > j; j++) {
                ...
                if (null === q.nTr && Ja(a, l), l = q.nTr, 0 !== e) {
                    var t = d[c % e];
    ...
    function ub(a) {
        var g, i, n, l, b = a.aoColumns, c = b.length, d = a.oFeatures, e = a.oPreviousSearch, f = a.aoPreSearchCols, j = [], q = W(a);
    ...
    function xb(a, b, c, d, e, f) {
        if ("" !== b) for (var g = a.aiDisplay, d = Qa(b, d, e, f), e = g.length - 1; e >= 0; e--) b = a.aoData[g[e]]._aFilterData[c], 
        ...
        return d || c.fnInit(a, b, e), f.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({
            fn: function(a) {
                if (d) {
                    ...
                    for (k = f.p.length; k > l; l++) Pa(a, "pageButton")(a, f.p[l], l, h, b, i);
                } else c.fnUpdate(a, e);
            },
            sName: "pagination"
        })), b;
    ...
    function ka(a) {
        var P, v, w, y, D, b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth, f = h(a.nScrollHead), g = f[0].style, j = f.children("div"), i = j[0].style, n = j.children("table"), j = a.nScrollBody, l = h(j), q = j.style, t = h(a.nScrollFoot).children("div"), m = t.children("table"), o = h(a.nTHead), G = h(a.nTable), p = G[0], r = p.style, u = a.nTFoot ? h(a.nTFoot) : null, Eb = a.oBrowser, Ua = Eb.bScrollOversize, s = F(a.aoColumns, "nTh"), z = [], A = [], B = [], C = [], E = function(a) {
        ...
        U(a)) : (a.scrollBarVis = v, G.children("thead, tfoot").remove(), u && (w = u.clone().prependTo(G), 
        P = u.find("tr"), w = w.find("tr")), y = o.clone().prependTo(G), o = o.find("tr"), 
    ...
    function Hb(a, b) {
        ...
        c = c.replace(ac, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, 
        e = f);
        return e;
    }
    function x(a) {
    ...
    function mb(a) {
        ...
        for (Ia(a), h = W(a), b = 0, c = h.length; c > b; b++) j = h[b], j.formatter && g++, 
        Ib(a, j.col);
    ...
    function Jb(a) {
        for (var b, c, d = a.aoColumns, e = W(a), a = a.oLanguage.oAria, f = 0, g = d.length; g > f; f++) {
            c = d[f];
            var j = c.asSorting;
    ...
    function Va(a, b, c, d) {
        ...
        "number" == typeof e[0] && (e = a.aaSorting = [ e ]), c && a.oFeatures.bSortMulti ? (c = h.inArray(b, F(e, "0")), 
    ...
    function xa(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            for (e = 0, f = b.length; f > e; e++) g = b[e].src, h(F(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e + 1 : 3));
            for (e = 0, f = d.length; f > e; e++) g = d[e].src, h(F(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3));
        }
        a.aLastSort = d;
    }
    function Ib(a, b) {
    ...
    function Aa(a, b) {
        ...
        return c >= b ? c = X(0, b) : d >= a ? (c = X(0, c - 2), c.push("ellipsis"), c.push(b - 1)) : (a >= b - 1 - d ? c = X(b - (c - 2), b) : (c = X(a - d + 2, a + d - 1), 
    ...
    var m, v, r, p, s, Ya = {}, Ob = /[\r\n]/g, Ca = /<.*?>/g, bc = /^[\w\+\-]/, cc = /[\w\+\-]$/, Zb = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"), Xa = /[',$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, M = function(a) {
        ...
        return M(a) ? !0 : (M(a) || "string" == typeof a) && Za(a.replace(Ca, ""), b, c) ? !0 : null;
    }, F = function(a, b, c) {
    ...
    m = function(a) {
        ...
        return this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase()) L(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                ...
                eb(e), e.oLanguage && Fa(e.oLanguage), e.aLengthMenu && !e.iDisplayLength && (e.iDisplayLength = h.isArray(e.aLengthMenu[0]) ? e.aLengthMenu[0][0] : e.aLengthMenu[0]), 
                ...
                for (g = 0, j = p.length; j > g; g++) Ga(o, t ? t[g] : null);
                ...
                var w = o.oFeatures;
                if (e.bStateSave && (w.bStateSave = !0, Kb(o, e), z(o, "aoDrawCallback", ya, "state_save")), 
    ...
    r = function(a, b) {
        ...
        iterator: function(a, b, c, d) {
            ...
            for ("string" == typeof a && (d = c, c = b, b = a, a = !1), g = 0, h = l.length; h > g; g++) {
                ...
                "column-rows" === b && (m = Da(l[g], p.opts)), i = 0, n = t.length; n > i; i++) f = t[i], 
    ...
    var $a = function(a, b, c, d, e) {
        ...
        c = a.aiDisplayMaster;
        var j = b.search;
        if (d = b.order, e = b.page, "ssp" == y(a)) return "removed" === j ? [] : X(0, c.length);
    ...
    p("columns()", function(a, b) {
        ...
        return this.iterator("column", function(c, d) {
            ...
            var j, i, n, e = c.aoColumns, f = e[d], g = c.aoData;
            if (a !== k && f.bVisible !== a) {
                if (a) {
                    var l = h.inArray(!0, F(e, "bVisible"), d + 1);
                    for (j = 0, i = g.length; i > j; j++) n = g[j].nTr, e = g[j].anCells, n && n.insertBefore(e[d], e[l] || null);
