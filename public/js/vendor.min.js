/*! koi-frontend - v1.0.0 - 2017-01-10 */
function _init() {
    "use strict";
    $.AdminLTE.layout = {
        activate: function() {
...
$.AdminLTE = {}, $.AdminLTE.options = {
    ...
    1: [ function(e, t) {
        !function() {
            ...
            e.prototype.needsClick = function(e) {
                ...
                e.preventDefault()), !1);
                return i && !o && (c = u.fastClickScrollParent, c && c.fastClickLastScrollTop !== c.scrollTop) ? !0 : (this.needsClick(u) || (e.preventDefault(), 
                this.sendClick(u, e)), !1);
            }, e.prototype.onTouchCancel = function() {
                this.trackingClick = !1, this.targetElement = null;
            }, e.prototype.onMouse = function(e) {
                return this.targetElement ? e.forwardedTouchEvent ? !0 : !e.cancelable || this.needsClick(this.targetElement) && !this.cancelNextClick ? !0 : (e.stopImmediatePropagation ? e.stopImmediatePropagation() : e.propagationStopped = !0, 
                e.stopPropagation(), e.preventDefault(), !1) : !0;
                ...
                o >= 27 && (t = document.querySelector("meta[name=viewport]"), t && (-1 !== t.content.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth)) ? !0 : "none" === e.style.touchAction || "manipulation" === e.style.touchAction);
    ...
    function k(a, b, d) {
        return a.data(q) ? a.data(q).o[b + (d ? "" : "Class")] : void 0;
    }
    function x(a) {
    ...
    h.fn[q] = function(a, b) {
        ...
        e(this), c.each(function() {
            ...
            "static" == g.css("position") && g.css("position", "relative"), F(a, !0, H), m.length && m.on("click.i mouseover.i mouseout.i touchbegin.i touchend.i", function(b) {
                ...
                var d = b[n];
                return b = b.keyCode, "click" == d ? !1 : "keydown" == d && 32 == b ? (c[n] == u && c[l] || (c[l] ? t(a, l) : D(a, l)), 
    ...
    var b = function() {
        ...
        return function() {
            ...
            return b.Extend(d, a), d.prototype.current = function(a) {
                ...
                var b = this;
                return this.$element.prop("multiple") ? (a.selected = !1, c(a.element).is("option") ? (a.element.selected = !1, 
    ...
    Datepicker.prototype = {
        ...
        fill: function() {
            var tooltip, d = new Date(this.viewDate), year = d.getUTCFullYear(), month = d.getUTCMonth(), startYear = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0), startMonth = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0), endYear = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, endMonth = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, todaytxt = dates[this.o.language].today || dates.en.today || "", cleartxt = dates[this.o.language].clear || dates.en.clear || "";
    ...
    "use strict";
    var i = function(t, n) {
        this.widget = "", this.$element = e(t), this.defaultTime = n.defaultTime, this.disableFocus = n.disableFocus, 
        this.isOpen = n.isOpen, this.minuteStep = n.minuteStep, this.modalBackdrop = n.modalBackdrop, 
        this.secondStep = n.secondStep, this.showInputs = n.showInputs, this.showMeridian = n.showMeridian, 
        this.showSeconds = n.showSeconds, this.template = n.template, this.appendWidgetTo = n.appendWidgetTo, 
        this.upArrowStyle = n.upArrowStyle, this.downArrowStyle = n.downArrowStyle, this.containerClass = n.containerClass, 
        this._init();
    };
    i.prototype = {
        constructor: i,
        _init: function() {
            ...
            this.$element.parent().hasClass("input-append") || this.$element.parent().hasClass("input-prepend") ? (this.$element.parent(".input-append, .input-prepend").find(".add-on").length ? this.$element.parent(".input-append, .input-prepend").find(".add-on").on({
                ...
                "keydown.timepicker": e.proxy(this.elementKeydown, this),
                "blur.timepicker": e.proxy(this.blurElement, this)
            }), this.template !== !1 ? this.$widget = e(this.getTemplate()).prependTo(this.$element.parents(this.appendWidgetTo)).on("click", e.proxy(this.widgetClick, this)) : this.$widget = !1, 
        ...
        decrementMinute: function(e) {
            var t;
            t = e ? this.minute - e : this.minute - this.minuteStep, 0 > t ? (this.decrementHour(), 
            this.minute = t + 60) : this.minute = t, this.update();
        },
        ...
        formatTime: function(e, t, n, r) {
            return e = 10 > e ? "0" + e : e, t = 10 > t ? "0" + t : t, n = 10 > n ? "0" + n : n, 
            e + ":" + t + (this.showSeconds ? ":" + n : "") + (this.showMeridian ? " " + r : "");
        },
        ...
        getTemplate: function() {
            var e, t, n, r, i, s;
            switch (this.showInputs ? (t = '<input type="text" name="hour" class="bootstrap-timepicker-hour form-control" maxlength="2"/>', 
            ...
            i = '<input type="text" name="meridian" class="bootstrap-timepicker-meridian form-control" maxlength="2"/>') : (t = '<span class="bootstrap-timepicker-hour"></span>', 
            n = '<span class="bootstrap-timepicker-minute"></span>', r = '<span class="bootstrap-timepicker-second"></span>', 
            i = '<span class="bootstrap-timepicker-meridian"></span>'), s = '<table><tr><td><a href="#" data-action="incrementHour"><i class="' + this.upArrowStyle + '"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="' + this.upArrowStyle + '"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="' + this.upArrowStyle + '"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="' + this.upArrowStyle + '"></i></a></td>' : "") + "</tr><tr><td>" + t + '</td> <td class="separator">:</td><td>' + n + "</td> " + (this.showSeconds ? '<td class="separator">:</td><td>' + r + "</td>" : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td>' + i + "</td>" : "") + '</tr><tr><td><a href="#" data-action="decrementHour"><i class="' + this.downArrowStyle + '"></i></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><i class="' + this.downArrowStyle + '"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="' + this.downArrowStyle + '"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><i class="' + this.downArrowStyle + '"></i></a></td>' : "") + "</tr></table>", 
            this.template) {
              case "modal":
        ...
        hideWidget: function() {
            ...
            e(n).off("mousedown.timepicker"), this.isOpen = !1);
        },
        ...
        incrementMinute: function(e) {
            var t;
            t = e ? this.minute + e : this.minute + this.minuteStep - this.minute % this.minuteStep, 
            t > 59 ? (this.incrementHour(), this.minute = t - 60) : this.minute = t, this.update();
        },
        ...
        setDefaultTime: function(e) {
            if (this.$element.val()) this.updateFromElementVal(); else if ("current" === e) {
                ...
                this.showMeridian && (0 === n ? n = 12 : n >= 12 ? (n > 12 && (n -= 12), s = "PM") : s = "AM"), 
        ...
        setTime: function(e) {
            var t, n;
            this.showMeridian ? (t = e.split(" "), n = t[0].split(":"), this.meridian = t[1]) : n = e.split(":"), 
            this.hour = parseInt(n[0], 10), this.minute = parseInt(n[1], 10), this.second = parseInt(n[2], 10), 
        ...
        showWidget: function() {
            if (!this.isOpen && !this.$element.is(":disabled")) {
                ...
                }), this.disableFocus && this.$element.blur(), this.updateFromElementVal(), "modal" === this.template && this.$widget.modal ? this.$widget.modal("show").on("hidden", e.proxy(this.hideWidget, this)) : this.isOpen === !1 && this.$widget.addClass("open"), 
                this.isOpen = !0;
            }
        },
        ...
        updateWidget: function() {
            if (this.$widget !== !1) {
                ...
                this.showInputs ? (this.$widget.find("input.bootstrap-timepicker-hour").val(e), 
                this.$widget.find("input.bootstrap-timepicker-minute").val(t), this.showSeconds && this.$widget.find("input.bootstrap-timepicker-second").val(n), 
                this.showMeridian && this.$widget.find("input.bootstrap-timepicker-meridian").val(this.meridian)) : (this.$widget.find("span.bootstrap-timepicker-hour").text(e), 
                this.$widget.find("span.bootstrap-timepicker-minute").text(t), this.showSeconds && this.$widget.find("span.bootstrap-timepicker-second").text(n), 
        ...
        return n.shift(), this.each(function() {
            var r = e(this), s = r.data("timepicker"), o = "object" == typeof t && t;
            s || r.data("timepicker", s = new i(this, e.extend({}, e.fn.timepicker.defaults, o, e(this).data()))), 
            "string" == typeof t && s[t].apply(s, n);
        });
    ...
    function eb(a) {
        ...
        "boolean" == typeof a.scrollX && (a.scrollX = a.scrollX ? "100%" : ""), a = a.aoSearchCols) for (var b = 0, c = a.length; c > b; b++) a[b] && K(m.models.oSearch, a[b]);
    }
    function fb(a) {
    ...
    function Ga(a) {
        ...
        for (e = 0, f = b.length; f > e; e++) if (l = b[e], t = [], !l.sType && l._sManualType) l.sType = l._sManualType; else if (!l.sType) {
            for (g = 0, j = d.length; j > g; g++) {
                for (i = 0, h = c.length; h > i && (t[i] === k && (t[i] = B(a, i, e, "type")), q = d[g](t[i], a), 
    ...
    function ib(a, b, c, d) {
        ...
        if (b) for (e = b.length - 1; e >= 0; e--) {
            ...
            for (h.isArray(q) || (q = [ q ]), f = 0, g = q.length; g > f; f++) if ("number" == typeof q[f] && 0 <= q[f]) {
                for (;l.length <= q[f]; ) Ea(a);
                d(q[f], n);
            } else if ("number" == typeof q[f] && 0 > q[f]) d(l.length + q[f], n); else if ("string" == typeof q[f]) for (j = 0, 
            i = l.length; i > j; j++) ("_all" == q[f] || h(l[j].nTh).hasClass(q[f])) && d(j, n);
        }
        if (c) for (e = 0, a = c.length; a > e; e++) d(e, c[e]);
    }
    function N(a, b, c, d) {
        ...
        for (var g = a.aoColumns, j = 0, i = g.length; i > j; j++) g[j].sType = null;
    ...
    function Q(a) {
        ...
        if ("string" == typeof a && (-1 !== a.indexOf(".") || -1 !== a.indexOf("[") || -1 !== a.indexOf("("))) {
            var c = function(a, b, f) {
                ...
                if ("" !== f) {
                    j = Ja(f);
                    for (var i = 0, n = j.length; n > i; i++) {
                        if (f = j[i].match(ba), g = j[i].match(U), f) {
                            if (j[i] = j[i].replace(ba, ""), "" !== j[i] && (a = a[j[i]]), g = [], j.splice(0, i + 1), 
                            j = j.join("."), h.isArray(a)) for (i = 0, n = a.length; n > i; i++) g.push(c(a[i], b, j));
    ...
    function R(a) {
        ...
        if ("string" == typeof a && (-1 !== a.indexOf(".") || -1 !== a.indexOf("[") || -1 !== a.indexOf("("))) {
            var b = function(a, d, e) {
                var f, e = Ja(e);
                f = e[e.length - 1];
                for (var g, j, i = 0, n = e.length - 1; n > i; i++) {
                    if (g = e[i].match(ba), j = e[i].match(U), g) {
                        if (e[i] = e[i].replace(ba, ""), a[e[i]] = [], f = e.slice(), f.splice(0, i + 1), 
                        g = f.join("."), h.isArray(d)) for (j = 0, n = d.length; n > j; j++) f = {}, b(f, d[j], g), 
    ...
    function oa(a, b, c) {
        for (var d = -1, e = 0, f = a.length; f > e; e++) a[e] == b ? d = e : a[e] > b && a[e]--;
    ...
    function Ia(a, b, c, d) {
        ...
        e.push(f)), f = f.nextSibling; else for (e = b.anCells, f = 0, g = e.length; g > f; f++) S(e[f]);
    ...
    function Ha(a, b, c, d) {
        ...
        if (null === e.nTr) {
            ...
            La(a, e), l = 0, q = a.aoColumns.length; q > l; l++) n = a.aoColumns[l], i = c ? d[l] : I.createElement(n.sCellType), 
            i._DT_CellIndex = {
                row: b,
                column: l
    ...
    function kb(a) {
        ...
        for (i && (e = h("<tr/>").appendTo(g)), b = 0, c = l.length; c > b; b++) f = l[b], 
        ...
        b = 0, c = a.length; c > b; b++) f = l[b], f.nTf = a[b].cell, f.sClass && h(f.nTf).addClass(f.sClass);
    }
    function ea(a, b, c) {
        var d, e, f, n, g = [], j = [], i = a.aoColumns.length;
        if (b) {
            for (c === k && (c = !1), d = 0, e = b.length; e > d; d++) {
                for (g[d] = b[d].slice(), g[d].nTr = b[d].nTr, f = i - 1; f >= 0; f--) !a.aoColumns[f].bVisible && !c && g[d].splice(f, 1);
                j.push([]);
            }
            for (d = 0, e = g.length; e > d; d++) {
                if (a = g[d].nTr) for (;f = a.firstChild; ) a.removeChild(f);
                for (f = 0, b = g[d].length; b > f; f++) if (n = i = 1, j[d][f] === k) {
                    for (a.appendChild(g[d][f].cell), j[d][f] = 1; g[d + i] !== k && g[d][f].cell == g[d + i][f].cell; ) j[d + i][f] = 1, 
                    i++;
                    for (;g[d][f + n] !== k && g[d][f].cell == g[d][f + n].cell; ) {
                        for (c = 0; i > c; c++) j[d + c][f + n] = 1;
                        n++;
                    }
    ...
    function O(a) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1); else {
            ...
            if (0 !== i.length) for (f = j ? a.aoData.length : n, j = j ? 0 : g; f > j; j++) {
    ...
    function nb(a) {
        ...
        for (var g, j, i, n, l, q, f = a.sDom.split(""), t = 0; t < f.length; t++) {
            ...
            q = 0, n = i.length; n > q; q++) if (j == i[q].cFeature) {
                g = i[q].fnInit(a);
                break;
            }
    ...
    function da(a, b) {
        ...
        for (a.splice(0, a.length), f = 0, i = c.length; i > f; f++) a.push([]);
        for (f = 0, i = c.length; i > f; f++) for (d = c[f], e = d.firstChild; e; ) {
            if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                for (l = 1 * e.getAttribute("colspan"), q = 1 * e.getAttribute("rowspan"), l = l && 0 !== l && 1 !== l ? l : 1, 
                q = q && 0 !== q && 1 !== q ? q : 1, g = 0, j = a[f]; j[g]; ) g++;
                for (n = g, t = 1 === l, j = 0; l > j; j++) for (g = 0; q > g; g++) a[f + g][n + j] = {
                    cell: e,
                    unique: t
                }, a[f + g].nTr = d;
            }
    ...
    function qa(a, b, c) {
        ...
        for (var b = 0, e = c.length; e > b; b++) for (var f = 0, g = c[b].length; g > f; f++) !c[b][f].unique || d[f] && a.bSortCellsTop || (d[f] = c[b][f].cell);
        return d;
    }
    function ra(a, b, c) {
    ...
    function ub(a) {
        ...
        for (g = 0; c > g; g++) n = b[g], l = f[g], i = "function" == typeof n.mData ? "function" : n.mData, 
        S.columns.push({
            data: i,
            name: n.sName,
    ...
    function yb(a) {
        for (var d, e, b = m.ext.search, c = a.aiDisplay, f = 0, g = b.length; g > f; f++) {
            for (var j = [], i = 0, n = c.length; n > i; i++) e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e, d._aData, i) && j.push(e);
            c.length = 0, h.merge(c, j);
        }
    }
    function xb(a, b, c, d, e, f) {
        if ("" !== b) for (var g = a.aiDisplay, d = Pa(b, d, e, f), e = g.length - 1; e >= 0; e--) b = a.aoData[g[e]]._aFilterData[c], 
    ...
    function wb(a, b, c, d, e, f) {
        ...
        b = a.aiDisplay, c = b.length - 1; c >= 0; c--) d.test(a.aoData[b[c]]._sFilterRow) || b.splice(c, 1);
    }
    function Pa(a, b, c, d) {
    ...
    function zb(a) {
        ...
        for (c = !1, d = 0, f = a.aoData.length; f > d; d++) if (h = a.aoData[d], !h._aFilterData) {
            for (j = [], e = 0, g = b.length; g > e; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), 
    ...
    function ga(a) {
        ...
        if (a.bInitialised) {
            ...
            b = 0, c = e.length; c > b; b++) f = e[b], f.sWidth && (f.nTh.style.width = x(f.sWidth));
    ...
    function ob(a) {
        ...
        }), g = 0, j = f.length; j > g; g++) e[0][g] = new Option(d[g], f[g]);
        ...
        return d || c.fnInit(a, b, e), f.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({
            fn: function(a) {
                if (d) {
                    ...
                    for (k = f.p.length; k > l; l++) Na(a, "pageButton")(a, f.p[l], l, h, b, i);
                } else c.fnUpdate(a, e);
            },
            sName: "pagination"
        })), b;
    ...
    function Ta(a, b, c) {
        ...
        0 > d && (d = 0)) : "next" == b ? f > d + e && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : L(a, 0, "Unknown paging action: " + b, 5), 
    ...
    function J(a, b, c) {
        for (var g, j, d = 0, e = 0, f = b.length; f > e; ) {
    ...
    function Fa(a) {
        ...
        if (d || !t && !f && !e && j == aa(a) && j == n.length) for (m = 0; j > m; m++) i = Z(a, m), 
    ...
    function Hb(a, b) {
        for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; g > f; f++) c = B(a, f, b, "display") + "", 
    ...
    function V(a) {
        ...
        a = 0; a < n.length; a++) for (i = n[a][0], f = e[i].aDataSort, b = 0, c = f.length; c > b; b++) g = f[b], 
    ...
    function mb(a) {
        ...
        for (Ga(a), h = V(a), b = 0, c = h.length; c > b; b++) j = h[b], j.formatter && g++, 
        Ib(a, j.col);
        if ("ssp" != y(a) && 0 !== h.length) {
            for (b = 0, c = i.length; c > b; b++) d[i[b]] = b;
            g === h.length ? i.sort(function(a, b) {
                var c, e, g, j, i = h.length, k = f[a]._aSortData, m = f[b]._aSortData;
                for (g = 0; i > g; g++) if (j = h[g], c = k[j.col], e = m[j.col], c = e > c ? -1 : c > e ? 1 : 0, 
                0 !== c) return "asc" === j.dir ? c : -c;
                return c = d[a], e = d[b], e > c ? -1 : c > e ? 1 : 0;
            }) : i.sort(function(a, b) {
                var c, g, j, i, k = h.length, m = f[a]._aSortData, p = f[b]._aSortData;
                for (j = 0; k > j; j++) if (i = h[j], c = m[i.col], g = p[i.col], i = e[i.type + "-" + i.dir] || e["string-" + i.dir], 
                c = i(c, g), 0 !== c) return c;
                return c = d[a], g = d[b], g > c ? -1 : c > g ? 1 : 0;
            });
        }
        a.bSorted = !0;
    }
    function Jb(a) {
        for (var b, c, d = a.aoColumns, e = V(a), a = a.oLanguage.oAria, f = 0, g = d.length; g > f; f++) {
            c = d[f];
            var j = c.asSorting;
    ...
    function va(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            for (e = 0, f = b.length; f > e; e++) g = b[e].src, h(G(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e + 1 : 3));
            for (e = 0, f = d.length; f > e; e++) g = d[e].src, h(G(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3));
        }
        a.aLastSort = d;
    }
    function Ib(a, b) {
        ...
        for (var f, g = m.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; i > j; j++) c = a.aoData[j], 
    ...
    function Kb(a) {
        ...
        if (a.oFeatures.bStateSave) {
            ...
            -1 === h.inArray(!1, b) && (b = a.iStateDuration, !(b > 0 && e.time < +new Date() - 1e3 * b) && d.length === e.columns.length))) {
                ...
                })), e.search !== k && h.extend(a.oPreviousSearch, Bb(e.search)), b = 0, c = e.columns.length; c > b; b++) {
                    var f = e.columns[b];
    ...
    function ya(a, b) {
        ...
        return c >= b ? c = W(0, b) : d >= a ? (c = W(0, c - 2), c.push("ellipsis"), c.push(b - 1)) : (a >= b - 1 - d ? c = W(b - (c - 2), b) : (c = W(a - d + 2, a + d - 1), 
    ...
    var v, r, p, s, m = function(a) {
        ...
        return this.each(function() {
            var j, e = {}, e = d > 1 ? Lb(e, a, !0) : a, g = 0, i = this.getAttribute("id"), n = !1, l = m.defaults, q = h(this);
            if ("table" != this.nodeName.toLowerCase()) L(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                ...
                t = qa(o)), null === e.aoColumns) for (p = [], g = 0, j = t.length; j > g; g++) p.push(null); else p = e.aoColumns;
                for (g = 0, j = p.length; j > g; g++) Ea(o, t ? t[g] : null);
                ...
                e.aaSorting === k) for (t = o.aaSorting, g = 0, j = t.length; j > g; g++) t[g][1] = o.aoColumns[g].asSorting[0];
        ...
        return M(a) ? !0 : (b && d && (a = Qb(a, b)), c && d && (a = a.replace(Xa, "")), 
        !isNaN(parseFloat(a)) && isFinite(a));
    }, Rb = function(a, b, c) {
        return M(a) ? !0 : (M(a) || "string" == typeof a) && Za(a.replace(Aa, ""), b, c) ? !0 : null;
    }, G = function(a, b, c) {
        var d = [], e = 0, f = a.length;
        if (c !== k) for (;f > e; e++) a[e] && a[e][b] && d.push(a[e][b][c]); else for (;f > e; e++) a[e] && d.push(a[e][b]);
        return d;
    }, ha = function(a, b, c, d) {
        var e = [], f = 0, g = b.length;
        if (d !== k) for (;g > f; f++) a[b[f]][c] && e.push(a[b[f]][c][d]); else for (;g > f; f++) e.push(a[b[f]][c]);
        return e;
    }, W = function(a, b) {
        var d, c = [];
        b === k ? (b = 0, d = a) : (d = b, b = a);
        for (var e = b; d > e; e++) c.push(e);
        return c;
    }, Sb = function(a) {
    ...
    m.util = {
        throttle: function(a, b) {
            ...
            return function() {
                ...
                d && d + c > g ? (clearTimeout(e), e = setTimeout(function() {
                    d = k, a.apply(b, h);
                }, c)) : (d = g, a.apply(b, h));
            };
        },
    ...
    r = function(a, b) {
        ...
        if (h.isArray(a)) for (var e = 0, f = a.length; f > e; e++) d(a[e]); else d(a);
        ...
        filter: function(a) {
            var b = [];
            if (w.filter) b = w.filter.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++) a.call(this, this[c], c, this) && b.push(this[c]);
        ...
        iterator: function(a, b, c, d) {
            ...
            for ("string" == typeof a && (d = c, c = b, b = a, a = !1), g = 0, h = l.length; h > g; g++) {
                var o = new r(l[g]);
                ...
                "column-rows" === b && (m = Ba(l[g], p.opts)), i = 0, n = t.length; n > i; i++) f = t[i], 
        ...
        map: function(a) {
            var b = [];
            if (w.map) b = w.map.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++) b.push(a.call(this, this[c], c));
            return new r(this.context, b);
        },
        pluck: function(a) {
        ...
        if (c.length && b && (b instanceof r || b.__dt_wrapper)) {
            ...
            for (d = 0, e = c.length; e > d; d++) f = c[d], b[f.name] = "function" == typeof f.val ? g(a, f.val, f) : h.isPlainObject(f.val) ? {} : f.val, 
            b[f.name].__dt_wrapper = !0, r.extend(a, b[f.name], f.propExt);
        }
    }, r.register = p = function(a, b) {
        if (h.isArray(a)) for (var c = 0, d = a.length; d > c; c++) r.register(a[c], b); else for (var g, j, e = a.split("."), f = Tb, c = 0, d = e.length; d > c; c++) {
            g = (j = -1 !== e[c].indexOf("()")) ? e[c].replace("()", "") : e[c];
            var i;
            a: {
                i = 0;
                for (var n = f.length; n > i; i++) if (f[i].name === g) {
                    i = f[i];
                    break a;
                }
                i = null;
    ...
    var Ub = function(a, b, c) {
        ...
        if ("ssp" == y(a)) T(a, b); else {
            ...
            e && 4 !== e.readyState && e.abort(), ra(a, [], function(c) {
                na(a);
                for (var c = sa(a, c), d = 0, e = c.length; e > d; d++) N(a, c[d]);
                T(a, b), C(a, !1);
            });
        }
    };
    ...
    var $a = function(a, b, c, d, e) {
        ...
        i = 0, n = b.length; n > i; i++) for (j = b[i] && b[i].split ? b[i].split(",") : [ b[i] ], 
        l = 0, m = j.length; m > l; l++) (g = c("string" == typeof j[l] ? h.trim(j[l]) : j[l])) && g.length && (f = f.concat(g));
        if (a = v.selector[a], a.length) for (i = 0, n = a.length; n > i; i++) f = a[i](d, e, f);
        return pa(f);
    }, ab = function(a) {
        ...
        if ("current" == e) for (c = a._iDisplayStart, d = a.fnDisplayEnd(); d > c; c++) f.push(g[c]); else if ("current" == d || "applied" == d) f = "none" == j ? c.slice() : "applied" == j ? g.slice() : h.map(c, function(a) {
            return -1 === h.inArray(a, g) ? a : null;
        }); else if ("index" == d || "original" == d) for (c = 0, d = a.aoData.length; d > c; c++) "none" == j ? f.push(c) : (e = h.inArray(c, g), 
        (-1 === e && "removed" == j || e >= 0 && "applied" == j) && f.push(c));
        return f;
    };
    p("rows()", function(a, b) {
        ...
        return this.iterator("row", function(b, c, d) {
            ...
            for (e.splice(c, 1), g = 0, h = e.length; h > g; g++) if (i = e[g], l = i.anCells, 
            null !== i.nTr && (i.nTr._DT_RowIndex = g), null !== l) for (i = 0, n = l.length; n > i; i++) l[i]._DT_CellIndex.row = g;
            oa(b.aiDisplayMaster, c), oa(b.aiDisplay, c), oa(a[d], c, !1), Sa(b), c = b.rowIdFn(f._aData), 
            c !== k && delete b.aIds[c];
        }), this.iterator("table", function(a) {
            for (var c = 0, d = a.aoData.length; d > c; c++) a.aoData[c].idx = c;
        }), this;
    }), p("rows.add()", function(a) {
        var b = this.iterator("table", function(b) {
            var c, f, g, h = [];
            for (f = 0, g = a.length; g > f; f++) c = a[f], c.nodeName && "TR" === c.nodeName.toUpperCase() ? h.push(ma(b, c)[0]) : h.push(N(b, c));
            return h;
        }, 1), c = this.rows(-1);
        ...
        if (c.length && a.length) {
            ...
            if (d._details) {
                ...
                0 < G(g, "_details").length && (f.on("draw.dt.DT_details", function(a, b) {
                    ...
                    if (e === b) for (var c, d = aa(b), f = 0, h = g.length; h > f; f++) c = g[f], c._details && c._details.children("td[colspan]").attr("colspan", d);
                }), f.on("destroy.dt.DT_details", function(a, b) {
                    if (e === b) for (var c = 0, d = g.length; d > c; c++) g[c]._details && cb(f, c);
                }));
            }
        }
    };
    p("row().child()", function(a, b) {
        ...
        if (!0 === a) this.child.show(); else if (!1 === a) cb(this); else if (c.length && this.length) {
            var d = c[0], c = c[0].aoData[this[0]], e = [], f = function(a, b) {
                if (h.isArray(a) || a instanceof h) for (var c = 0, k = a.length; k > c; c++) f(a[c], b); else a.nodeName && "tr" === a.nodeName.toLowerCase() ? e.push(a) : (c = h("<tr><td/></tr>").addClass(b), 
    ...
    var ec = /^(.+):(name|visIdx|visible)$/, Wb = function(a, b, c, d, e) {
        for (var c = [], d = 0, f = e.length; f > d; d++) c.push(B(a, e[d], b));
        return c;
    };
    p("columns()", function(a, b) {
        ...
        var c = this.iterator("column", function(b, c) {
            ...
            if (a !== k && g.bVisible !== a) {
                if (a) {
                    ...
                    for (i = 0, n = j.length; n > i; i++) l = j[i].nTr, f = j[i].anCells, l && l.insertBefore(f[c], f[m] || null);
        ...
        h.isPlainObject(b) && (c = b, b = null), null === b || b === k) return this.iterator("table", function(b) {
            ...
            return $a("cell", d, function(a) {
                ...
                if (null === a || a === k || c) {
                    for (m = [], p = 0, r = g.length; r > p; p++) for (l = g[p], u = 0; n > u; u++) v = {
                        row: l,
                        column: u
        ...
        var f, g, j, i, n, d = this.columns(b, c), e = this.rows(a, c), l = this.iterator("table", function(a, b) {
            for (f = [], g = 0, j = e[b].length; j > g; g++) for (i = 0, n = d[b].length; n > i; i++) f.push({
                row: e[b][g],
                column: d[b][i]
            });
            return f;
        ...
        for (var c, d, b = m.version.split("."), a = a.split("."), e = 0, f = a.length; f > e; e++) if (c = parseInt(b[e], 10) || 0, 
        ...
        var c = h.map(m.settings, function(b) {
            return !a || a && h(b.nTable).is(":visible") ? b.nTable : void 0;
        });
        return b ? new r(c) : c;
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var k, l, r, g = a.oClasses, j = a.oLanguage.oPaginate, i = a.oLanguage.oAria.paginate || {}, m = 0, p = function(b, d) {
                    ...
                    for (o = 0, r = d.length; r > o; o++) if (s = d[o], h.isArray(s)) u = h("<" + (s.DT_el || "div") + "/>").appendTo(b), 
                    p(u, s); else {
                        switch (k = null, l = "", s) {
                          case "ellipsis":
                          ...
                          case "next":
                            k = j.sNext, l = s + (f - 1 > e ? "" : " " + g.sPageButtonDisabled);
                            break;

                          case "last":
                            k = j.sLast, l = s + (f - 1 > e ? "" : " " + g.sPageButtonDisabled);
                            break;
    ...
    return b.extend(!0, f.defaults, {
        ...
        var e, g, i, o = new f.Api(a), s = a.oClasses, k = a.oLanguage.oPaginate, t = a.oLanguage.oAria.paginate || {}, p = 0, q = function(d, f) {
            ...
            for (l = 0, h = f.length; h > l; l++) if (c = f[l], b.isArray(c)) q(d, c); else {
                switch (g = e = "", c) {
                  case "ellipsis":
                    e = "&#x2026;", g = "disabled";
                    break;
                  ...
                  case "first":
                    e = k.sFirst, g = c + (j > 0 ? "" : " disabled");
                    break;

                  case "previous":
                    e = k.sPrevious, g = c + (j > 0 ? "" : " disabled");
                    break;

                  case "next":
                    e = k.sNext, g = c + (n - 1 > j ? "" : " disabled");
                    break;

                  case "last":
                    e = k.sLast, g = c + (n - 1 > j ? "" : " disabled");
                    break;
    ...
    "function" == typeof define && define.amd ? define([ "jquery", "datatables.net", "datatables.net-buttons" ], function($) {
        return factory($, window, document);
    }) : "object" == typeof exports ? module.exports = function(root, $) {
        return root || (root = window), $ && $.fn.dataTable || ($ = require("datatables.net")(root, $).$), 
        $.fn.dataTable.Buttons || require("datatables.net-buttons")(root, $), factory($, root, root.document);
    } : factory(jQuery, window, document);
}(function($, window, document, undefined) {
    "use strict";
    var DataTable = $.fn.dataTable, _saveAs = function(view) {
            ...
            var doc = view.document, get_URL = function() {
                ...
                var object_url, target_view, slice, filesaver = this, type = blob.type, blob_changed = !1, dispatch_all = function() {
                    ...
                    target_view) target_view.location.href = object_url; else {
                        ...
                        new_tab === undefined && "undefined" != typeof safari && (view.location.href = object_url);
                    }
    ...
    }(window), _filename = function(config, incExtension) {
        var filename = "*" === config.filename && "*" !== config.title && config.title !== undefined ? config.title : config.filename;
        return "function" == typeof filename && (filename = filename()), -1 !== filename.indexOf("*") && (filename = filename.replace("*", $("title").text())), 
        filename = filename.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""), incExtension === undefined || incExtension === !0 ? filename + config.extension : filename;
    }, _sheetname = function(config) {
        var sheetName = "Sheet1";
        return config.sheetName && (sheetName = config.sheetName.replace(/[\[\]\*\/\\\?\:]/g, "")), 
        sheetName;
    }, _title = function(config) {
        var title = config.title;
        return "function" == typeof title && (title = title()), -1 !== title.indexOf("*") ? title.replace("*", $("title").text()) : title;
    }, _newLine = function(config) {
        return config.newline ? config.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n";
    }, _exportData = function(dt, config) {
        for (var newLine = _newLine(config), data = dt.buttons.exportData(config.exportOptions), boundary = config.fieldBoundary, separator = config.fieldSeparator, reBoundary = new RegExp(boundary, "g"), escapeChar = config.escapeChar !== undefined ? config.escapeChar : "\\", join = function(a) {
            for (var s = "", i = 0, ien = a.length; ien > i; i++) i > 0 && (s += separator), 
            s += boundary ? boundary + ("" + a[i]).replace(reBoundary, escapeChar + boundary) + boundary : a[i];
            return s;
        }, header = config.header ? join(data.header) + newLine : "", footer = config.footer && data.footer ? newLine + join(data.footer) : "", body = [], i = 0, ien = data.body.length; ien > i; i++) body.push(join(data.body[i]));
        return {
    ...
    return DataTable.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5",
        text: function(dt) {
            return dt.i18n("buttons.copy", "Copy");
        },
        action: function(e, dt, button, config) {
            var exportData = _exportData(dt, config), output = exportData.str, hiddenDiv = $("<div/>").css({
                height: 1,
                width: 1,
                overflow: "hidden",
                position: "fixed",
            ...
            if (document.queryCommandSupported("copy")) {
                hiddenDiv.appendTo(dt.table().container()), textarea[0].focus(), textarea[0].select();
                try {
                    return document.execCommand("copy"), hiddenDiv.remove(), void dt.buttons.info(dt.i18n("buttons.copyTitle", "Copy to clipboard"), dt.i18n("buttons.copySuccess", {
            ...
            textarea[0].focus(), textarea[0].select();
            var container = $(message).closest(".dt-button-info"), close = function() {
                container.off("click.buttons-copy"), $(document).off(".buttons-copy"), dt.buttons.info(!1);
            };
            container.on("click.buttons-copy", close), $(document).on("keydown.buttons-copy", function(e) {
                27 === e.keyCode && close();
        ...
        action: function(e, dt, button, config) {
            var output = (_newLine(config), _exportData(dt, config).str), charset = config.charset;
            config.customize && (output = config.customize(output, config)), charset !== !1 ? (charset || (charset = document.characterSet || document.charset), 
            charset && (charset = ";charset=" + charset)) : charset = "", _saveAs(new Blob([ output ], {
        ...
        action: function(e, dt, button, config) {
            var xml = "", data = dt.buttons.exportData(config.exportOptions), addRow = function(row) {
                for (var cells = [], i = 0, ien = row.length; ien > i; i++) null !== row[i] && row[i] !== undefined || (row[i] = ""), 
                cells.push("number" == typeof row[i] || row[i].match && $.trim(row[i]).match(/^-?\d+(\.\d+)?$/) && "0" !== row[i].charAt(0) ? '<c t="n"><v>' + row[i] + "</v></c>" : '<c t="inlineStr"><is><t>' + (row[i].replace ? row[i].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : row[i]) + "</t></is></c>");
                return "<row>" + cells.join("") + "</row>";
            };
            config.header && (xml += addRow(data.header));
            for (var i = 0, ien = data.body.length; ien > i; i++) xml += addRow(data.body[i]);
            config.footer && (xml += addRow(data.footer));
            var zip = new window.JSZip(), _rels = zip.folder("_rels"), xl = zip.folder("xl"), xl_rels = zip.folder("xl/_rels"), xl_worksheets = zip.folder("xl/worksheets");
            zip.file("[Content_Types].xml", excelStrings["[Content_Types].xml"]), _rels.file(".rels", excelStrings["_rels/.rels"]), 
            xl.file("workbook.xml", excelStrings["xl/workbook.xml"].replace("__SHEET_NAME__", _sheetname(config))), 
            xl_rels.file("workbook.xml.rels", excelStrings["xl/_rels/workbook.xml.rels"]), xl_worksheets.file("sheet1.xml", excelStrings["xl/worksheets/sheet1.xml"].replace("__DATA__", xml)), 
            _saveAs(zip.generate({
                type: "blob",
        ...
        action: function(e, dt, button, config) {
            var data = (_newLine(config), dt.buttons.exportData(config.exportOptions)), rows = [];
            config.header && rows.push($.map(data.header, function(d) {
                return {
                    text: "string" == typeof d ? d : d + "",
                    style: "tableHeader"
                };
            }));
            for (var i = 0, ien = data.body.length; ien > i; i++) rows.push($.map(data.body[i], function(d) {
                return {
                    text: "string" == typeof d ? d : d + "",
                    style: i % 2 ? "tableBodyEven" : "tableBodyOdd"
                };
            }));
            config.footer && rows.push($.map(data.footer, function(d) {
                return {
                    text: "string" == typeof d ? d : d + "",
                    style: "tableFooter"
                };
            ...
            config.message && doc.content.unshift({
                text: config.message,
                style: "message",
                margin: [ 0, 0, 0, 12 ]
            }), config.title && doc.content.unshift({
                text: _title(config, !1),
                style: "title",
                margin: [ 0, 0, 0, 12 ]
            }), config.customize && config.customize(doc, config);
            var pdf = window.pdfMake.createPdf(doc);
            "open" !== config.download || _isSafari() ? pdf.getBuffer(function(buffer) {
    ...
    $.extend(Buttons.prototype, {
        ...
        active: function(idx, flag) {
            ...
            return flag === undefined ? button.node.hasClass(klass) : (button.node.toggleClass(klass, flag === undefined ? !0 : flag), 
            this);
        },
        add: function(idx, config) {
            if ("string" == typeof idx && -1 !== idx.indexOf("-")) {
                var idxs = idx.split("-");
        ...
        destroy: function() {
            ...
            for (i = 0, ien = buttons.length; ien > i; i++) for (this.removePrep(i), j = 0, 
            jen = subButtons[i].length; jen > j; j++) this.removePrep(i + "-" + j);
            this.removeCommit(), this.dom.container.remove();
            var buttonInsts = this.s.dt.settings()[0];
            for (i = 0, ien = buttonInsts.length; ien > i; i++) if (buttonInsts.inst === this) {
        ...
        removeCommit: function() {
            ...
            for (i = 0, ien = subButtons.length; ien > i; i++) for (j = subButtons[i].length - 1; j >= 0; j--) null === subButtons[i][j] && (subButtons[i].splice(j, 1), 
            this.c.buttons[i].buttons.splice(j, 1));
            return this;
        },
        removePrep: function(idx) {
            var button, dt = this.s.dt;
            if ("number" == typeof idx || -1 === idx.indexOf("-")) button = this.s.buttons[1 * idx], 
        ...
        text: function(idx, label) {
            var button = this._indexToButton(idx), buttonLiner = this.c.dom.collection.buttonLiner, linerTag = "string" == typeof idx && -1 !== idx.indexOf("-") && buttonLiner && buttonLiner.tag ? buttonLiner.tag : this.c.dom.buttonLiner.tag, dt = this.s.dt, text = function(opt) {
        ...
        toIndex: function(node) {
            var i, ien, j, jen, buttons = this.s.buttons, subButtons = this.s.subButtons;
            for (i = 0, ien = buttons.length; ien > i; i++) if (buttons[i].node[0] === node) return i + "";
            for (i = 0, ien = subButtons.length; ien > i; i++) for (j = 0, jen = subButtons[i].length; jen > j; j++) if (subButtons[i][j].node[0] === node) return i + "-" + j;
        },
        _constructor: function() {
            ...
            dtSettings._buttons || (dtSettings._buttons = []), dtSettings._buttons.push({
                ...
                if (!document.activeElement || document.activeElement === document.body) {
                    ...
                    -1 !== that.s.listenKeys.toLowerCase().indexOf(character) && that._keypress(character, e);
                }
            });
        },
        ...
        _buildButtons: function(buttons, container, collectionCounter) {
            ...
            for (var i = 0, ien = buttons.length; ien > i; i++) {
        ...
        _indexToButton: function(idx) {
            if ("number" == typeof idx || -1 === idx.indexOf("-")) return this.s.buttons[1 * idx];
            var idxs = idx.split("-");
        ...
        _keypress: function(character, e) {
            ...
            for (i = 0, ien = buttons.length; ien > i; i++) run(buttons[i].conf, buttons[i].node);
            for (i = 0, ien = subButtons.length; ien > i; i++) for (j = 0, jen = subButtons[i].length; jen > j; j++) run(subButtons[i][j].conf, subButtons[i][j].node);
        },
        ...
        _resolveExtends: function(conf) {
            ...
            for (conf = toConfObject(conf); conf && conf.extend; ) {
                ...
                if (postfixButtons) {
                    for (conf.buttons || (conf.buttons = []), i = 0, ien = postfixButtons.length; ien > i; i++) conf.buttons.push(postfixButtons[i]);
                    conf.postfixButtons = null;
                }
                var prefixButtons = conf.prefixButtons;
                if (prefixButtons) {
                    for (conf.buttons || (conf.buttons = []), i = 0, ien = prefixButtons.length; ien > i; i++) conf.buttons.splice(i, 0, prefixButtons[i]);
        ...
        var ret = [], names = $.map(buttons, function(v) {
            ...
            if ($.isArray(input)) for (var i = 0, ien = input.length; ien > i; i++) process(input[i]); else if ("string" == typeof input) if (-1 !== input.indexOf(",")) process(input.split(",")); else {
                var idx = $.inArray($.trim(input), names);
                -1 !== idx && ret.push(buttons[idx].inst);
        ...
        for (var ret = [], run = function(selector, inst) {
            ...
            if ($.isArray(selector) || selector instanceof $) for (i = 0, ien = selector.length; ien > i; i++) run(selector[i], inst); else if (null === selector || selector === undefined || "*" === selector) for (i = 0, 
            ien = buttons.length; ien > i; i++) ret.push({
                inst: inst,
                idx: inst.toIndex(buttons[i].node)
            }); else if ("number" == typeof selector) ret.push({
                inst: inst,
                idx: selector
            }); else if ("string" == typeof selector) if (-1 !== selector.indexOf(",")) {
                var a = selector.split(",");
                for (i = 0, ien = a.length; ien > i; i++) run($.trim(a[i]), inst);
            } else if (selector.match(/^\d+(\-\d+)?$/)) ret.push({
                inst: inst,
                idx: selector
            }); else if (-1 !== selector.indexOf(":name")) {
                var name = selector.replace(":name", "");
                for (i = 0, ien = buttons.length; ien > i; i++) buttons[i].name === name && ret.push({
                    inst: inst,
                    idx: inst.toIndex(buttons[i].node)
                });
        ...
        collection: {
            ...
            action: function(e, dt, button, config) {
                ...
                if (multiLevel && "absolute" === position) config._collection.css({
                    ...
                    top > $(window).height() / 2 && (top = $(window).height() / 2), config._collection.css("marginTop", -1 * top);
                }
        ...
        return selector === undefined && (selector = group, group = undefined), this.iterator(!0, "table", function(ctx) {
            return ctx._buttons ? Buttons.buttonSelector(Buttons.instanceSelector(group, ctx._buttons), selector) : void 0;
        }, !0);
    ...
    DataTable.Api.register("buttons.info()", function(title, message, time) {
        ...
        return this.context.length ? _exportData(new DataTable.Api(this.context[0]), options) : void 0;
    });
    var _exportTextarea = $("<textarea/>")[0], _exportData = function(dt, inOpts) {
        ...
        }).toArray() : null, rowIndexes = dt.rows(config.rows, config.modifier).indexes().toArray(), cells = dt.cells(rowIndexes, config.columns).render(config.orthogonal).toArray(), columns = header.length, rows = columns > 0 ? cells.length / columns : 0, body = new Array(rows), cellCounter = 0, i = 0, ien = rows; ien > i; i++) {
            for (var row = new Array(columns), j = 0; columns > j; j++) row[j] = config.format.body(cells[cellCounter], j, i), 
            cellCounter++;
            body[i] = row;
        }
        return {
    ...
    function j(a, b, d) {
        ...
        for (e = 0, h = a.length; h > e; e++) c[e] = b.call(d, a[e], e, a);
        return c;
    }
    function n(a, b) {
    ...
    function x(a) {
        ...
        return "function" == typeof a && (a = a()), q(a) && a.match("%v") ? {
            pos: a,
            neg: a.replace("-", "").replace("%v", "-%v"),
            zero: a
        } : a && a.pos && a.pos.match("%v") ? a : q(b) ? c.settings.currency.format = {
            pos: b,
            neg: b.replace("%v", "-%v"),
            zero: b
        } : b;
    ...
    var c = {
        ...
        return (a > 0 ? g.pos : 0 > a ? g.neg : g.zero).replace("%s", f.symbol).replace("%v", t(Math.abs(a), n(f.precision), f.thousand, f.decimal));
    };
    c.formatColumn = function(a, b, d, i, e, h) {
        ...
        var f = s(r(b) ? b : {
            ...
            decimal: e,
            format: h
        }, c.settings.currency), g = x(f.format), l = g.pos.indexOf("%s") < g.pos.indexOf("%v"), k = 0, a = j(a, function(a) {
            return m(a) ? c.formatColumn(a, f) : (a = o(a), a = (a > 0 ? g.pos : 0 > a ? g.neg : g.zero).replace("%s", f.symbol).replace("%v", t(Math.abs(a), n(f.precision), f.thousand, f.decimal)), 
            a.length > k && (k = a.length), a);
        });
        return j(a, function(a) {
            return q(a) && a.length < k ? l ? a.replace(f.symbol, f.symbol + Array(k - a.length + 1).join(" ")) : Array(k - a.length + 1).join(" ") + a : a;
        });
    }, "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = c), 
    exports.accounting = c) : "function" == typeof define && define.amd ? define([], function() {
        return c;
    }) : (c.noConflict = function(a) {
        return function() {
            return p.accounting = a, c.noConflict = z, c;
        };
    ...
    var laroute = function() {
        var routes = {
            ...
            routes: [ {
                ...
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "terceros/facturap",
                name: "terceros.facturap",
                action: "AppHttpControllersAdminTerceroController@facturap"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                ...
                methods: [ "POST" ],
                uri: "terceros/contactos",
                name: "terceros.contactos.store",
                action: "AppHttpControllersAdminContactoController@store"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "terceros/contactos/{contactos}",
                name: "terceros.contactos.update",
                action: "AppHttpControllersAdminContactoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "terceros/contactos/{contactos}",
                ...
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "actividades/create",
                name: "actividades.create",
                action: "AppHttpControllersAdminActividadController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "actividades",
                name: "actividades.store",
                action: "AppHttpControllersAdminActividadController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "actividades/{actividades}",
                name: "actividades.show",
                action: "AppHttpControllersAdminActividadController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "actividades/{actividades}/edit",
                name: "actividades.edit",
                action: "AppHttpControllersAdminActividadController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "actividades/{actividades}",
                name: "actividades.update",
                action: "AppHttpControllersAdminActividadController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "actividades/{actividades}",
                ...
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "departamentos/{departamentos}",
                name: "departamentos.show",
                action: "AppHttpControllersAdminDepartamentoController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "sucursales",
                name: "sucursales.index",
                action: "AppHttpControllersAdminSucursalController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "sucursales/create",
                name: "sucursales.create",
                action: "AppHttpControllersAdminSucursalController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "sucursales",
                name: "sucursales.store",
                action: "AppHttpControllersAdminSucursalController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "sucursales/{sucursales}",
                name: "sucursales.show",
                action: "AppHttpControllersAdminSucursalController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "sucursales/{sucursales}/edit",
                name: "sucursales.edit",
                action: "AppHttpControllersAdminSucursalController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "sucursales/{sucursales}",
                name: "sucursales.update",
                action: "AppHttpControllersAdminSucursalController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "sucursales/{sucursales}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "puntosventa",
                name: "puntosventa.index",
                action: "AppHttpControllersAdminPuntoVentaController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "puntosventa/create",
                name: "puntosventa.create",
                action: "AppHttpControllersAdminPuntoVentaController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "puntosventa",
                name: "puntosventa.store",
                action: "AppHttpControllersAdminPuntoVentaController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "puntosventa/{puntosventa}",
                name: "puntosventa.show",
                action: "AppHttpControllersAdminPuntoVentaController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "puntosventa/{puntosventa}/edit",
                name: "puntosventa.edit",
                action: "AppHttpControllersAdminPuntoVentaController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "puntosventa/{puntosventa}",
                name: "puntosventa.update",
                action: "AppHttpControllersAdminPuntoVentaController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "puntosventa/{puntosventa}",
                ...
                action: "AppHttpControllersAccountingDocumentoController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                ...
                action: "AppHttpControllersAccountingDocumentoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "documentos/{documentos}",
                ...
                host: null,
                methods: [ "DELETE" ],
                uri: "asientos/detalle/{detalle}",
                name: "asientos.detalle.destroy",
                action: "AppHttpControllersAccountingDetalleAsientoController@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "asientos/exportar/{asientos}",
                name: "asientos.exportar",
                action: "AppHttpControllersAccountingAsientoController@exportar"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "asientos/detalle/evaluate",
                name: "asientos.detalle.evaluate",
                action: "AppHttpControllersAccountingDetalleAsientoController@evaluate"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "asientos/detalle/validate",
                name: "asientos.detalle.validate",
                action: "AppHttpControllersAccountingDetalleAsientoController@validation"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "asientos/detalle/movimientos",
                name: "asientos.detalle.movimientos",
                action: "AppHttpControllersAccountingDetalleAsientoController@movimientos"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "asientos",
                ...
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "asientos/{asientos}/edit",
                name: "asientos.edit",
                action: "AppHttpControllersAccountingAsientoController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "asientos/{asientos}",
                name: "asientos.update",
                action: "AppHttpControllersAccountingAsientoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "asientos/{asientos}",
                ...
                uri: "folders",
                name: "folders.index",
                action: "AppHttpControllersAccountingFolderController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "folders/create",
                name: "folders.create",
                action: "AppHttpControllersAccountingFolderController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "folders",
                name: "folders.store",
                action: "AppHttpControllersAccountingFolderController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "folders/{folders}",
                name: "folders.show",
                action: "AppHttpControllersAccountingFolderController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "folders/{folders}/edit",
                name: "folders.edit",
                action: "AppHttpControllersAccountingFolderController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "folders/{folders}",
                name: "folders.update",
                action: "AppHttpControllersAccountingFolderController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "folders/{folders}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "facturap/search",
                name: "facturap.search",
                action: "AppHttpControllersAccountingFacturapController@search"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "facturap/cuotas",
                name: "facturap.cuotas.index",
                action: "AppHttpControllersAccountingFacturapCuotasController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "facturap",
                name: "facturap.index",
                action: "AppHttpControllersAccountingFacturapController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/search",
                name: "ordenes.search",
                action: "AppHttpControllersProductionOrdenpController@search"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/exportar/{ordenes}",
                name: "ordenes.exportar",
                action: "AppHttpControllersProductionOrdenpController@exportar"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/productos/formula",
                name: "ordenes.productos.formula",
                action: "AppHttpControllersProductionDetalleOrdenpController@formula"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/productos",
                name: "ordenes.productos.index",
                action: "AppHttpControllersProductionDetalleOrdenpController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/productos/create",
                name: "ordenes.productos.create",
                action: "AppHttpControllersProductionDetalleOrdenpController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "ordenes/productos",
                name: "ordenes.productos.store",
                action: "AppHttpControllersProductionDetalleOrdenpController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/productos/{productos}",
                name: "ordenes.productos.show",
                action: "AppHttpControllersProductionDetalleOrdenpController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/productos/{productos}/edit",
                name: "ordenes.productos.edit",
                action: "AppHttpControllersProductionDetalleOrdenpController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "ordenes/productos/{productos}",
                name: "ordenes.productos.update",
                action: "AppHttpControllersProductionDetalleOrdenpController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "ordenes/productos/{productos}",
                ...
                methods: [ "DELETE" ],
                uri: "ordenes/productos/{productos}",
                name: "ordenes.productos.destroy",
                action: "AppHttpControllersProductionDetalleOrdenpController@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/despachos/exportar/{despachos}",
                name: "ordenes.despachos.exportar",
                action: "AppHttpControllersProductionDespachopController@exportar"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/despachos/pendientes",
                name: "ordenes.despachos.pendientes",
                action: "AppHttpControllersProductionDespachopController@pendientes"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/despachos",
                name: "ordenes.despachos.index",
                action: "AppHttpControllersProductionDespachopController@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "ordenes/despachos",
                name: "ordenes.despachos.store",
                action: "AppHttpControllersProductionDespachopController@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "ordenes/despachos/{despachos}",
                name: "ordenes.despachos.destroy",
                action: "AppHttpControllersProductionDespachopController@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes",
                name: "ordenes.index",
                action: "AppHttpControllersProductionOrdenpController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/create",
                name: "ordenes.create",
                action: "AppHttpControllersProductionOrdenpController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "ordenes",
                name: "ordenes.store",
                action: "AppHttpControllersProductionOrdenpController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/{ordenes}",
                name: "ordenes.show",
                action: "AppHttpControllersProductionOrdenpController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "ordenes/{ordenes}/edit",
                name: "ordenes.edit",
                action: "AppHttpControllersProductionOrdenpController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "ordenes/{ordenes}",
                name: "ordenes.update",
                action: "AppHttpControllersProductionOrdenpController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "ordenes/{ordenes}",
                ...
                uri: "areasp",
                name: "areasp.index",
                action: "AppHttpControllersProductionAreaspController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "areasp/create",
                name: "areasp.create",
                action: "AppHttpControllersProductionAreaspController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "areasp",
                name: "areasp.store",
                action: "AppHttpControllersProductionAreaspController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "areasp/{areasp}",
                name: "areasp.show",
                action: "AppHttpControllersProductionAreaspController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "areasp/{areasp}/edit",
                name: "areasp.edit",
                action: "AppHttpControllersProductionAreaspController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "areasp/{areasp}",
                name: "areasp.update",
                action: "AppHttpControllersProductionAreaspController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "areasp/{areasp}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "acabadosp",
                name: "acabadosp.index",
                action: "AppHttpControllersProductionAcabadospController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "acabadosp/create",
                name: "acabadosp.create",
                action: "AppHttpControllersProductionAcabadospController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "acabadosp",
                name: "acabadosp.store",
                action: "AppHttpControllersProductionAcabadospController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "acabadosp/{acabadosp}",
                name: "acabadosp.show",
                action: "AppHttpControllersProductionAcabadospController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "acabadosp/{acabadosp}/edit",
                name: "acabadosp.edit",
                action: "AppHttpControllersProductionAcabadospController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "acabadosp/{acabadosp}",
                name: "acabadosp.update",
                action: "AppHttpControllersProductionAcabadospController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "acabadosp/{acabadosp}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "maquinasp",
                name: "maquinasp.index",
                action: "AppHttpControllersProductionMaquinaspController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "maquinasp/create",
                name: "maquinasp.create",
                action: "AppHttpControllersProductionMaquinaspController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "maquinasp",
                name: "maquinasp.store",
                action: "AppHttpControllersProductionMaquinaspController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "maquinasp/{maquinasp}",
                name: "maquinasp.show",
                action: "AppHttpControllersProductionMaquinaspController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "maquinasp/{maquinasp}/edit",
                name: "maquinasp.edit",
                action: "AppHttpControllersProductionMaquinaspController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "maquinasp/{maquinasp}",
                name: "maquinasp.update",
                action: "AppHttpControllersProductionMaquinaspController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "maquinasp/{maquinasp}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "materialesp",
                name: "materialesp.index",
                action: "AppHttpControllersProductionMaterialespController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "materialesp/create",
                name: "materialesp.create",
                action: "AppHttpControllersProductionMaterialespController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "materialesp",
                name: "materialesp.store",
                action: "AppHttpControllersProductionMaterialespController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "materialesp/{materialesp}",
                name: "materialesp.show",
                action: "AppHttpControllersProductionMaterialespController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "materialesp/{materialesp}/edit",
                name: "materialesp.edit",
                action: "AppHttpControllersProductionMaterialespController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "materialesp/{materialesp}",
                name: "materialesp.update",
                action: "AppHttpControllersProductionMaterialespController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "materialesp/{materialesp}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "productosp/tips",
                name: "productosp.tips.index",
                action: "AppHttpControllersProductionProductop2Controller@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp/tips",
                name: "productosp.tips.store",
                action: "AppHttpControllersProductionProductop2Controller@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "productosp/tips/{tips}",
                name: "productosp.tips.destroy",
                action: "AppHttpControllersProductionProductop2Controller@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/areas",
                name: "productosp.areas.index",
                action: "AppHttpControllersProductionProductop3Controller@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp/areas",
                name: "productosp.areas.store",
                action: "AppHttpControllersProductionProductop3Controller@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "productosp/areas/{areas}",
                name: "productosp.areas.destroy",
                action: "AppHttpControllersProductionProductop3Controller@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/maquinas",
                name: "productosp.maquinas.index",
                action: "AppHttpControllersProductionProductop4Controller@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp/maquinas",
                name: "productosp.maquinas.store",
                action: "AppHttpControllersProductionProductop4Controller@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "productosp/maquinas/{maquinas}",
                name: "productosp.maquinas.destroy",
                action: "AppHttpControllersProductionProductop4Controller@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/materiales",
                name: "productosp.materiales.index",
                action: "AppHttpControllersProductionProductop5Controller@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp/materiales",
                name: "productosp.materiales.store",
                action: "AppHttpControllersProductionProductop5Controller@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "productosp/materiales/{materiales}",
                name: "productosp.materiales.destroy",
                action: "AppHttpControllersProductionProductop5Controller@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/acabados",
                name: "productosp.acabados.index",
                action: "AppHttpControllersProductionProductop6Controller@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp/acabados",
                name: "productosp.acabados.store",
                action: "AppHttpControllersProductionProductop6Controller@store"
            }, {
                host: null,
                methods: [ "DELETE" ],
                uri: "productosp/acabados/{acabados}",
                name: "productosp.acabados.destroy",
                action: "AppHttpControllersProductionProductop6Controller@destroy"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp",
                name: "productosp.index",
                action: "AppHttpControllersProductionProductopController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/create",
                name: "productosp.create",
                action: "AppHttpControllersProductionProductopController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productosp",
                name: "productosp.store",
                action: "AppHttpControllersProductionProductopController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/{productosp}",
                name: "productosp.show",
                action: "AppHttpControllersProductionProductopController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productosp/{productosp}/edit",
                name: "productosp.edit",
                action: "AppHttpControllersProductionProductopController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "productosp/{productosp}",
                name: "productosp.update",
                action: "AppHttpControllersProductionProductopController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "productosp/{productosp}",
                ...
                uri: "grupos",
                name: "grupos.index",
                action: "AppHttpControllersInventoryGrupoController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "grupos/create",
                name: "grupos.create",
                action: "AppHttpControllersInventoryGrupoController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "grupos",
                name: "grupos.store",
                action: "AppHttpControllersInventoryGrupoController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "grupos/{grupos}",
                name: "grupos.show",
                action: "AppHttpControllersInventoryGrupoController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "grupos/{grupos}/edit",
                name: "grupos.edit",
                action: "AppHttpControllersInventoryGrupoController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "grupos/{grupos}",
                name: "grupos.update",
                action: "AppHttpControllersInventoryGrupoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "grupos/{grupos}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "subgrupos",
                name: "subgrupos.index",
                action: "AppHttpControllersInventorySubGrupoController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "subgrupos/create",
                name: "subgrupos.create",
                action: "AppHttpControllersInventorySubGrupoController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "subgrupos",
                name: "subgrupos.store",
                action: "AppHttpControllersInventorySubGrupoController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "subgrupos/{subgrupos}",
                name: "subgrupos.show",
                action: "AppHttpControllersInventorySubGrupoController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "subgrupos/{subgrupos}/edit",
                name: "subgrupos.edit",
                action: "AppHttpControllersInventorySubGrupoController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "subgrupos/{subgrupos}",
                name: "subgrupos.update",
                action: "AppHttpControllersInventorySubGrupoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "subgrupos/{subgrupos}",
                ...
                uri: "unidades",
                name: "unidades.index",
                action: "AppHttpControllersInventoryUnidadesMedidaController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "unidades/create",
                name: "unidades.create",
                action: "AppHttpControllersInventoryUnidadesMedidaController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "unidades",
                name: "unidades.store",
                action: "AppHttpControllersInventoryUnidadesMedidaController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "unidades/{unidades}",
                name: "unidades.show",
                action: "AppHttpControllersInventoryUnidadesMedidaController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "unidades/{unidades}/edit",
                name: "unidades.edit",
                action: "AppHttpControllersInventoryUnidadesMedidaController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "unidades/{unidades}",
                name: "unidades.update",
                action: "AppHttpControllersInventoryUnidadesMedidaController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "unidades/{unidades}",
                ...
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "traslados/detalle",
                name: "traslados.detalle.index",
                action: "AppHttpControllersInventoryDetalleTrasladoController@index"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "traslados/detalle",
                name: "traslados.detalle.store",
                action: "AppHttpControllersInventoryDetalleTrasladoController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "traslados",
                name: "traslados.index",
                action: "AppHttpControllersInventoryTrasladosController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "traslados/create",
                name: "traslados.create",
                action: "AppHttpControllersInventoryTrasladosController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "traslados",
                name: "traslados.store",
                action: "AppHttpControllersInventoryTrasladosController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "traslados/{traslados}",
                name: "traslados.show",
                action: "AppHttpControllersInventoryTrasladosController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos/search",
                name: "productos.search",
                action: "AppHttpControllersInventoryProductoController@search"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos/rollos",
                name: "productos.rollos.index",
                action: "AppHttpControllersInventoryProdbodeRolloController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos",
                name: "productos.index",
                action: "AppHttpControllersInventoryProductoController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos/create",
                name: "productos.create",
                action: "AppHttpControllersInventoryProductoController@create"
            }, {
                host: null,
                methods: [ "POST" ],
                uri: "productos",
                name: "productos.store",
                action: "AppHttpControllersInventoryProductoController@store"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos/{productos}",
                name: "productos.show",
                action: "AppHttpControllersInventoryProductoController@show"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "productos/{productos}/edit",
                name: "productos.edit",
                action: "AppHttpControllersInventoryProductoController@edit"
            }, {
                host: null,
                methods: [ "PUT" ],
                uri: "productos/{productos}",
                name: "productos.update",
                action: "AppHttpControllersInventoryProductoController@update"
            }, {
                host: null,
                methods: [ "PATCH" ],
                uri: "productos/{productos}",
                ...
                methods: [ "GET", "HEAD" ],
                uri: "rplancuentas",
                name: "rplancuentas.index",
                action: "AppHttpControllersReportPlanCuentasController@index"
            }, {
                host: null,
                methods: [ "GET", "HEAD" ],
                uri: "rmayorbalance",
                name: "rmayorbalance.index",
                action: "AppHttpControllersReportMayorBalanceController@index"
            } ],
            prefix: "",
            route: function(name, parameters, route) {
                return (route = route || this.getByName(name)) ? this.toRoute(route, parameters) : void 0;
            },
