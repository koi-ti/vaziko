			...
			<form method="POST" accept-charset="UTF-8" id="form-asientos" data-toggle="validator">
		    	<div class="box box-success spinner-main">
		    		<div class="box-body" id="render-form-asientos">
						<div class="row">
							<label for="asiento1_ano" class="col-xs-12 col-sm-1 col-md-1 control-label">Fecha</label>
						...
						<div class="row">
							...
							<label for="asiento1_documento" class="col-xs-12 col-sm-1 col-md-1 control-label">Documento</label>
							...
							<label for="asiento1_numero" class="col-xs-12 col-sm-1 col-md-1 control-label">Número</label>
						...
						<div class="row">
							<label for="asiento1_beneficiario" class="col-xs-12 col-sm-1 col-md-1 control-label">Beneficiario</label>
							<div class="form-group col-xs-12 col-sm-3 col-md-3">
							...
							<div class="form-group col-xs-10 col-sm-7 col-md-5">
							...
							<div class="form-group col-xs-2 col-sm-1 col-md-1">
						...
						<div class="row">
							<label for="asiento1_detalle" class="col-xs-12 col-sm-1 col-md-1 control-label">Detalle</label>
				...
				<div class="box-body">
					<% if (edit) { %> <form method="POST" accept-charset="UTF-8" id="form-item-asiento" data-toggle="validator"> <% } %>
						...
						<div class="row">
							...
							<div class="form-group col-sm-1 text-right col-xs-12">
							...
							<div class="form-group col-sm-2 col-xs-12">
								...
								<input id="empresa_round" name="empresa_round" type="hidden" value="{{ $empresa->empresa_round }}">
							</div>
						</div>
						<div class="row">
							...
							<div class="form-group col-sm-1 col-xs-12 text-right">
		...
		<div class="row"><br>
			...
			<div class="form-group col-sm-2">
	      		<div class="input-group input-group-sm">
					...
					<input id="factura1_asiento" name="factura1_asiento" placeholder="Factura" class="form-control factura-koi-component" type="text" maxlength="15" data-factura="true" data-nit="factura1_tercero_nit" data-name="factura1_asiento_beneficiario" data-referencia="factura1_referencia" data-activo="saldo" readonly required>
		...
		<br />
            ...
            <div class="form-group col-sm-2 col-xs-12">
                <div class="input-group input-group-sm">
                    ...
                    <input id="producto_codigo" placeholder="Producto" class="form-control producto-koi-component evaluate-producto-movimiento-asiento" name="producto_codigo" type="text" maxlength="15" data-wrapper="traslados-create" data-name="producto_nombre" data-asiento="true" data-naturaleza="<%- (asiento2_naturaleza == 'D') ? 'D' : 'C' %>" required>
                </div>
            </div>
            <div class="form-group col-sm-4 <%- asiento2_naturaleza == 'D' ? 'col-xs-10' : 'col-xs-12' %>">
