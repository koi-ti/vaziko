        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    ...
                    <div>
                        <input type="checkbox" disabled {{ $producto->producto_unidades ? 'checked': '' }}>
                    </div>
                </div>
                <div class="form-group col-md-2">
                    <label class="control-label">¿Meneja serie?</label>
                    <div>
                        <input type="checkbox" disabled {{ $producto->producto_serie ? 'checked': '' }}>
                    </div>
                </div>
                <div class="form-group col-md-2">
                    <label class="control-label">¿Producto metrado?</label>
                    <div>
                        <input type="checkbox" disabled {{ $producto->producto_metrado ? 'checked': '' }}>
                    </div>
                </div>
