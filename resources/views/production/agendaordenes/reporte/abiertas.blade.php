...
<table class="rtable" border="0" cellspacing="0" cellpadding="0">
    ...
    <tbody>
        ...
        @foreach($abiertas as $orden)
            <tr>
                <td class="bg-abiertas">{{ $orden->orden_codigo }}</td>
                <td class="bg-abiertas">{{ $orden->tercero_nombre }}</td>
                <td class="bg-abiertas text-center" colspan="4">{{ $orden->orden_fecha }}</td>
            </tr>
