                            ...
                            <li class="pull-right">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('Diseplanea'))
                                        ...
                                        <% } %>
                                    @endif
                                    @ability ('precotizar' | 'cotizaciones')
                                        <% if (cotizacion1_estados != 'CS') { %>
                                ...
                                <div class="box-body">
                                    <form method="POST" accept-charset="UTF-8" id="form-cotizaciones" data-toggle="validator">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2 col-sm-1 col-md-1">
                                                <button type="button" class="btn btn-danger btn-flat btn-sm btn-remove-resource-koi-component" data-field="cotizacion1_vendedor">
