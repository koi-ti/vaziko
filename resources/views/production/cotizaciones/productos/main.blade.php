                                        ...
                                        <div class="list-group-item list-group-item-success">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3 col-sm-2">
                                                    <input id="cotizacion2_volumen" name="cotizacion2_volumen" class="form-control input-sm total-calculate" value="<%- cotizacion2_volumen %>" type="number" min="0" step="0.1" max="99">
                                                </div>
