                                ...
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input id="cotizacion2_round_materialp" name="cotizacion2_round_materialp" class="form-control input-sm event-price" value="<%- cotizacion2_round_materialp %>" type="number" min="-2" max="2" step="1" title="Si el digito se encuentra en 0, sera redondeado automaticamente">
                                            </div>
