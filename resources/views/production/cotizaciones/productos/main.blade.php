                        ...
                        @if ($producto->images->count())
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="box box-danger">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Imágenes del producto</h3>
                                        </div>
                                        <div class="box-body">
                                            <ul class="list-group">
                                                @foreach ($producto->images as $image)
                                                    <li class="list-group-item">
                                                        <img src='{{ asset("storage/productosp/productop_{$image->productopimagen_productop}/{$image->productopimagen_archivo}") }}' style="max-width: 500px; height: 200px;">
                                                        <label class="control-label">Incluir en la cotización <input type="checkbox" class="incluir-cotizacion" data-resource="{{ $image->id }}"></label>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                            ...
                            <form method="POST" accept-charset="UTF-8" id="form-areap-producto" data-toggle="validator">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-2 col-md-offset-2">
                                        <input type="number" id="cotizacion6_horas" name="cotizacion6_horas" placeholder="Hora" value="0" class="form-control input-xs" min="0" step="1" max="9999" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group col-sm-2">
                                        <input type="number" id="cotizacion6_minutos" name="cotizacion6_minutos" placeholder="Minutos" value="0" class="form-control input-xs" min="0" step="01" max="59" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group col-sm-3">
                        ...
                        <div class="box-body">
                            <form method="POST" accept-charset="UTF-8" id="form-transporte-producto" data-toggle="validator">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <input id="cotizacion10_nombre" name="cotizacion10_nombre" placeholder="Nombre" class="form-control input-sm input-toupper" type="text" maxlength="200">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-2 col-md-offset-2">
                                ...
                                <div class="list-group">
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-1 @elseability col-sm-10 @endability text-right"><small id="percentage-precio" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-1 @elseability col-sm-10 @endability text-right"><small id="percentage-viaticos" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-2 text-left"><b>Materiales</b></div>
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-8 @endability text-right"><small id="info-prev-materiales" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-1 col-sm-1 @elseability col-sm-2 @endability text-right"><small id="percentage-materiales" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-2 text-left"><b>Áreas</b></div>
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-8 @endability text-right"><small id="info-prev-areasp" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-1 col-sm-1 @elseability col-sm-2 @endability text-right"><small id="percentage-areasp" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-2 text-left"><b>Empaques</b></div>
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-8 @endability text-right"><small id="info-prev-empaques" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-1 col-sm-1 @elseability col-sm-2 @endability text-right"><small id="percentage-empaques" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-2 text-left"><b>Transportes</b></div>
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-8 @endability text-right"><small id="info-prev-transportes" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                            ...
                                            @endability
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-1 col-sm-1 @elseability col-sm-2 @endability text-right"><small id="percentage-transportes" class="badge bg-info">0%</small></div>
                                        </div>
                                    </div>
                                    @ability ('especial' | 'cotizaciones')
                                    ...
                                    <div class="list-group-item list-group-item-success">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-descuento" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                                    <input id="cotizacion2_descuento" name="cotizacion2_descuento" class="form-control input-sm total-calculate" value="<%- cotizacion2_descuento %>" type="number" min="0" max="100" step="0.1">
                                                </div>
                                                <div class="col-xs-2 col-sm-1 text-center"><small>(%)</small></div>
                                    ...
                                    <div class="list-group-item list-group-item-success">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'cotizaciones') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-comision" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'cotizaciones')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                                    <input id="cotizacion2_comision" name="cotizacion2_comision" class="form-control input-sm total-calculate" value="<%- (!edit) ? '{{ ($cotizacion->vendedor) ? $cotizacion->vendedor->tercero_comision : 0 }}' : cotizacion2_comision %>" type="number" min="0" max="100" step="0.1">
                                                </div>
                                                <div class="col-xs-2 col-sm-1 text-center"><small>(%)</small></div>
