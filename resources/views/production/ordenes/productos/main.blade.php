                                ...
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'ordenes') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-materiales" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'ordenes')
                                    ...
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'ordenes') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-areasp" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'ordenes')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                    ...
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'ordenes') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-empaques" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'ordenes')
                                                <div class="col-xs-4 col-sm-2 text-left">
                                    ...
                                    <div class="list-group-item list-group-item-info">
                                        <div class="row">
                                            ...
                                            <div class="@ability ('especial' | 'ordenes') col-xs-6 col-sm-3 @elseability col-sm-10 @endability text-right"><small id="info-prev-transportes" class="badge bg-red"></small></div>
                                            @ability ('especial' | 'ordenes')
                                                <div class="col-xs-4 col-sm-2 text-left">
