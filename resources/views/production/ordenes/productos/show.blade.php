...
@section('module')
	...
	<section class="content">
		<div class="box box-solid" id="ordenes-productos-show">
			<div class="nav-tabs-custom tab-success tab-whithout-box-shadow">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab_producto" data-toggle="tab">Producto</a></li>
					@if( $orden->orden_cotizacion )
						<li><a href="#tab_imagenes" data-toggle="tab">Imágenes pre-cotizadas</a></li>
					@endif
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_producto">
					...
					@if($orden->orden_cotizacion)
						<div class="tab-pane" id="tab_imagenes">
							<div class="box box-solid">
								<div class="box-body">
									<div id="fine-uploader" data-referencia="{{ $ordenp2->precotizacion2_id }}"></div>
								</div>
							</div>
						</div>
					@endif
