							...
							<div class="list-group">
								@ability ('especial' | 'ordenes')
									<div class="list-group-item list-group-item-info">
										<div class="row">
											...
											<div class="col-xs-9 col-sm-8 text-right"><b>{{ number_format($ordenp2->orden2_precio_venta, 2, ',', '.')}}</b></div>
								...
								<div class="list-group-item list-group-item-danger">
									<div class="row">
										...
										<div class="@ability ('especial' | 'ordenes') col-xs-6 col-sm-2 @elseability col-sm-10 @endability text-right">
											<span class="badge bg-red">{{ number_format($totalsubtotal, 2, ',', '.') }} x {{ $ordenp2->orden2_cantidad }}</span>
										</div>
										@ability ('especial' | 'ordenes')
											<div class="col-xs-10 col-sm-5 text-right">
