...
@section('content')
        ...
        <section class="content">
            <div class="box box-success spinner-main">
                ...
                <div class="box-body">
                    ...
                    {{-- Content transporte --}}
                    <div id="transportes-wrapper-producto" class="box box-success">
                        <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            <form method="POST" accept-charset="UTF-8" id="form-transporte-producto" data-toggle="validator">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <select name="precotizacion10_materialp" id="precotizacion10_materialp" class="form-control select2-default-clear change-materialp" data-placeholder="Transportes de producción" data-field="precotizacion10_producto" data-wrapper="transportes-wrapper-producto" data-reference="transporte" required>
                                            <option value hidden selected>Seleccione</option>
                                    ...
                                    <div class="form-group col-sm-6">
                                        <select name="precotizacion10_producto" id="precotizacion10_producto" class="form-control select2-default-clear" data-placeholder="Insumo" data-valor="precotizacion10_valor_unitario" disabled required>
                                            <option value hidden selected>Seleccione</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-8">
                                        <div class="input-group">
                                            <input type="text" id="precotizacion10_medidas" name="precotizacion10_medidas" placeholder="Medidas" class="form-control input-xs input-formula calculate-formula" data-response="precotizacion10_cantidad" maxlength="50" required>
                                            <span class="input-group-addon">=</span>
                                            <input type="text" id="precotizacion10_cantidad" name="precotizacion3_cantidad" class="form-control text-right" placeholder="Total" disabled>
                                        </div>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <input id="precotizacion10_valor_unitario" name="precotizacion10_valor_unitario" class="form-control input-sm" type="text" required data-currency>
                                    </div>
                                    <div class="form-group col-sm-1">
                                        <button type="submit" class="btn btn-success btn-sm btn-block">
                                            <i class="fa fa-plus"></i>
                            ...
                            <!-- table table-bordered table-striped -->
                            <div class="box-body table-responsive no-padding">
                                <table id="browse-precotizacion-producto-transportes-list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th colspan="2"></th>
    ...
    <script type="text/template" id="precotizacion-delete-transporte-confirm-tpl">
    ...
    <script type="text/template" id="precotizacion-producto-transporte-item-tpl">
        <% if( edit ) { %>
            <td class="text-center">
                <a class="btn btn-default btn-xs item-producto-transporte-precotizacion-remove" data-resource="<%- id %>">
                    <span><i class="fa fa-times"></i></span>
                </a>
            </td>
            <td class="text-center">
                <a class="btn btn-default btn-xs item-producto-transporte-precotizacion-edit" data-resource="<%- id %>">
                    <span><i class="fa fa-pencil-square-o"></i></span>
                </a>
            </td>
        <% } %>
        ...
        <td><%- !_.isUndefined(producto_nombre) && !_.isNull(producto_nombre) ? producto_nombre : "-" %></td>
        <td><%- precotizacion10_medidas %></td>
        <td><%- precotizacion10_cantidad %></td>
        <td class="text-right"><%- window.Misc.currency( precotizacion10_valor_unitario ) %></td>
        <td class="text-right"><%- window.Misc.currency( precotizacion10_valor_total ) %></td>
    </script>

    <script type="text/template" id="precotizacion-producto-transporte-edit-item-tpl">
        <td class="text-center" colspan="2">
            <a class="btn btn-success btn-xs item-producto-transporte-precotizacion-success" data-resource="<%- id %>">
                <span><i class="fa fa-check"></i></span>
            </a>
        </td>
        <td><%- !_.isUndefined(producto_nombre) && !_.isNull(producto_nombre) ? producto_nombre : "-" %></td>
        <td colspan="4">
            <div class="input-group">
                <input type="text" id="precotizacion10_medidas_<%- id %>" name="precotizacion10_medidas_<%- id %>" value="<%- precotizacion10_medidas %>" placeholder="Medidas" class="form-control input-xs input-formula calculate-formula" data-response="precotizacion10_cantidad_<%- id %>" maxlength="50" required>
                <span class="input-group-addon">=</span>
                <input type="text" id="precotizacion10_cantidad_<%- id %>" name="precotizacion10_cantidad_<%- id %>" value="<%- precotizacion10_cantidad %>" placeholder="Total" class="form-control text-right" disabled>
            </div>
        </td>
        <td colspan="2" class="text-right">
            <input id="precotizacion10_valor_unitario_<%- id %>" name="precotizacion10_valor_unitario_<%- id %>" value="<%- precotizacion10_valor_unitario %>" class="form-control input-sm" type="text" data-currency required>
        </td>
    </script>
    ...
    <script type="text/template" id="qq-template-precotizacion-producto">
        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="{{ trans('app.files.drop') }}">
            ...
            @if( Auth::user()->ability('admin', 'opcional3', ['module' => 'precotizaciones']) )
                <div class="buttons">
