							...
							@if ($producto->productop_tiro)
								<div class="row">
									<div class="col-sm-offset-2 col-md-1 col-xs-3">
										...
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_tiro ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_yellow ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_magenta ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_cyan ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_key ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_color1 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_color2 ? 'checked': '' }}>
									</div>
								</div>
							@endif
							...
							@if ($producto->productop_retiro)
								<div class="row">
									<div class="col-sm-offset-2 col-md-1 col-xs-3">
										...
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_retiro ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_yellow2 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_magenta2 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_cyan2 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_key2 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_color12 ? 'checked': '' }}>
									</div>
									<div class="col-md-1 col-xs-1">
										<input type="checkbox" disabled {{ $precotizacion2->precotizacion2_color22 ? 'checked': '' }}>
									</div>
								</div>
							@endif
						...
						<table id="browse-precotizacion-producto-materiales-list" class="table table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									@ability ('precios' | 'precotizaciones')
