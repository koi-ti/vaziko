...
@section('breadcrumb')
	...
	<li><a href="{{ route('tipoproductosp.show', ['tipoproductop' => $tipoproductop->id]) }}">{{ $tipoproductop->tipoproductop_nombre }}</a></li>
			...
			<div class="box-footer with-border">
	        	<div class="row">
					<div class="col-md-2 col-md-offset-4 col-sm-6 col-xs-6 text-left">
						<a href="{{ route('tipoproductosp.show', ['tipoproductosp' => $tipoproductop->id]) }}" class="btn btn-default btn-sm btn-block">{{ trans('app.cancel') }}</a>
					</div>
