...
@section('title') Reporte balance comparativo @stop

@section('content')
    <section class="content-header">
		<h1>
			Reporte balance comparativo
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> {{ trans('app.home') }}</a></li>
			<li class="active">Reporte balance comparativo</li>
		</ol>
    </section>

   	<section class="content">
	    <div class="box box-success">
	    	<form action="{{ route('rbalancecomparativo.index') }}" method="GET" data-toggle="validator">
