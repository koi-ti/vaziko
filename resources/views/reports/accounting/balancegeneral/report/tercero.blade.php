            ...
            @foreach ($saldos as $saldo)
                ...
                @if (count($saldo->saldosterceros))
                    <tr>
                        ...
                        <th align="right">{{$total_inicial}}</th>
                        <th align="right">{{ number_format($saldo->saldosterceros->sum('debitomes'), 2, ',', '.') }}</th>
                        <th align="right">{{ number_format($saldo->saldosterceros->sum('creditomes'), 2, ',', '.') }}</th>
