...
@section('title') Reporte estado de resultado @stop
...
@section('content')
    <section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Reporte estado de resultado</li>
		</ol>
    </section>

   	<section class="content">
	    <div class="box box-success">
	    	<form action="{{ route('restadoresultado.index') }}" method="GET" data-toggle="validator">
                ...
                @ability ('exportar' | 'restadoresultado')
