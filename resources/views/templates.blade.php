...
<script type="text/template" id="producto-item-show-tpl">
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-11">
                    <textarea class="form-control" rows="2" disabled><%- orden2_observaciones %></textarea>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <% if (producto.productop_tiro) { %>
                                    <tr>
                                        <th class="text-center">T <input type="checkbox" disabled <%- parseInt(orden2_tiro) ? 'checked': ''%>></th>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_yellow) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_magenta) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_cyan) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_key) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_color1) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_color2) ? 'checked': ''%>></td>
                                    </tr>
                                <% } %>
                                <% if (producto.productop_retiro) { %>
                                    <tr>
                                        <th class="text-center">R <input type="checkbox" disabled <%- parseInt(orden2_retiro) ? 'checked': ''%>></th>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_yellow2) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_magenta2) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_cyan2) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_key2) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_color12) ? 'checked': ''%>></td>
                                        <td class="text-center"><input type="checkbox" disabled <%- parseInt(orden2_color22) ? 'checked': ''%>></td>
                                    </tr>
                                <% } %>
                            </tbody>
                        </table>
                ...
                <div class="row">
                    <% if (producto.productop_tiro) { %>
                        <div class="form-group <%- (producto.productop_tiro && producto.productop_retiro) ? 'col-sm-6' : 'col-sm-12' %>">
                            ...
                            <textarea class="form-control" rows="2" placeholder="Nota tiro" disabled><%- orden2_nota_tiro %></textarea>
                        </div>
                    <% } %>
                    ...
                    <% if (producto.productop_retiro) { %>
                        <div class="form-group <%- (producto.productop_tiro && producto.productop_retiro) ? 'col-sm-6' : 'col-sm-12' %>">
                            ...
                            <textarea class="form-control" rows="2" placeholder="Nota retiro" disabled><%- orden2_nota_retiro %></textarea>
                        </div>
                    <% } %>
                </div>
            </div>
